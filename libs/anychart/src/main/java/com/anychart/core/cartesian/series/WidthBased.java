...
public class WidthBased extends BaseWithMarkers {
    ...
    public WidthBased(String jsChart) {
     ...
     */
    public com.anychart.core.cartesian.series.WidthBased a11y(Boolean value) {
     ...
     * Setter for the accessibility setting.
     */
    public com.anychart.core.cartesian.series.WidthBased a11y(String value) {
     ...
     */
    public com.anychart.core.cartesian.series.WidthBased bottom(Number bottom) {
     ...
     * Setter for element bottom bound settings.
     */
    public com.anychart.core.cartesian.series.WidthBased bottom(String bottom) {
     ...
     */
    public com.anychart.core.cartesian.series.WidthBased bounds(com.anychart.utils.RectObj bounds) {
     ...
     * Setter for bounds of the element using one parameter.
     */
    public com.anychart.core.cartesian.series.WidthBased bounds(com.anychart.math.Rect bounds) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".bounds(%s);", (bounds != null) ? bounds.getJsBase() : null));
     ...
     * Setter for bounds of the element using one parameter.
     */
    public com.anychart.core.cartesian.series.WidthBased bounds(com.anychart.core.utils.Bounds bounds) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".bounds(%s);", (bounds != null) ? bounds.getJsBase() : null));
     ...
     */
    public com.anychart.core.cartesian.series.WidthBased bounds(Number x, Number y, Number width, Number height) {
     ...
     * Setter for element bounds settings.
     */
    public com.anychart.core.cartesian.series.WidthBased bounds(Number x, Number y, Number width, String height) {
     ...
     * Setter for element bounds settings.
     */
    public com.anychart.core.cartesian.series.WidthBased bounds(Number x, Number y, String width, Number height) {
     ...
     * Setter for element bounds settings.
     */
    public com.anychart.core.cartesian.series.WidthBased bounds(Number x, Number y, String width, String height) {
     ...
     * Setter for element bounds settings.
     */
    public com.anychart.core.cartesian.series.WidthBased bounds(Number x, String y, Number width, Number height) {
     ...
     * Setter for element bounds settings.
     */
    public com.anychart.core.cartesian.series.WidthBased bounds(Number x, String y, Number width, String height) {
     ...
     * Setter for element bounds settings.
     */
    public com.anychart.core.cartesian.series.WidthBased bounds(Number x, String y, String width, Number height) {
     ...
     * Setter for element bounds settings.
     */
    public com.anychart.core.cartesian.series.WidthBased bounds(Number x, String y, String width, String height) {
     ...
     * Setter for element bounds settings.
     */
    public com.anychart.core.cartesian.series.WidthBased bounds(String x, Number y, Number width, Number height) {
     ...
     * Setter for element bounds settings.
     */
    public com.anychart.core.cartesian.series.WidthBased bounds(String x, Number y, Number width, String height) {
     ...
     * Setter for element bounds settings.
     */
    public com.anychart.core.cartesian.series.WidthBased bounds(String x, Number y, String width, Number height) {
     ...
     * Setter for element bounds settings.
     */
    public com.anychart.core.cartesian.series.WidthBased bounds(String x, Number y, String width, String height) {
     ...
     * Setter for element bounds settings.
     */
    public com.anychart.core.cartesian.series.WidthBased bounds(String x, String y, Number width, Number height) {
     ...
     * Setter for element bounds settings.
     */
    public com.anychart.core.cartesian.series.WidthBased bounds(String x, String y, Number width, String height) {
     ...
     * Setter for element bounds settings.
     */
    public com.anychart.core.cartesian.series.WidthBased bounds(String x, String y, String width, Number height) {
     ...
     * Setter for element bounds settings.
     */
    public com.anychart.core.cartesian.series.WidthBased bounds(String x, String y, String width, String height) {
     ...
     */
    public com.anychart.core.cartesian.series.WidthBased clip(Boolean value) {
     ...
     * Setter for series clip settings.
     */
    public com.anychart.core.cartesian.series.WidthBased clip(com.anychart.math.Rect value) {
     ...
     * 
     */
    public com.anychart.core.cartesian.series.WidthBased color(com.anychart.graphics.vector.Fill value) {
     ...
     */
    public com.anychart.core.cartesian.series.WidthBased enabled(Boolean enabled) {
     ...
     */
    public com.anychart.core.cartesian.series.WidthBased error(String settings) {
     ...
     * Setter for the series error.
     */
    public com.anychart.core.cartesian.series.WidthBased error(Boolean settings) {
     ...
     * Setter for the series error.
     */
    public com.anychart.core.cartesian.series.WidthBased error(Number settings) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".error(%s);", settings));
...
<b>Note:</b> Works only after {@link anychart.charts.Cartesian#draw} is called.
     ...
     */
    public com.anychart.core.cartesian.series.WidthBased height(Number height) {
     ...
     * Setter for element height setting.
     */
    public com.anychart.core.cartesian.series.WidthBased height(String height) {
     ...
     * Hovers points.
     */
    public com.anychart.core.cartesian.series.WidthBased hover() {
     ...
     */
    public com.anychart.core.cartesian.series.WidthBased hover(Number index) {
     ...
     */
    public com.anychart.core.cartesian.series.WidthBased hover(Number[] indexes) {
     ...
     */
    public com.anychart.core.cartesian.series.WidthBased hovered(String settings) {
     ...
     */
    public com.anychart.core.cartesian.series.WidthBased id(String id) {
     ...
     * Setter for the series id.
     */
    public com.anychart.core.cartesian.series.WidthBased id(Number id) {
     ...
     */
    public com.anychart.core.cartesian.series.WidthBased labels(String settings) {
     ...
     * Setter for series data labels.
     */
    public com.anychart.core.cartesian.series.WidthBased labels(Boolean settings) {
     ...
     */
    public com.anychart.core.cartesian.series.WidthBased left(Number left) {
     ...
     * Setter for element left bound settings.
     */
    public com.anychart.core.cartesian.series.WidthBased left(String left) {
     ...
     * 
     */
    public com.anychart.core.cartesian.series.WidthBased legendItem(String value) {
     ...
     */
    public com.anychart.core.cartesian.series.WidthBased markers(String settings) {
     ...
     * Setter for series data markers.
     */
    public com.anychart.core.cartesian.series.WidthBased markers(Boolean settings) {
     ...
     */
    public com.anychart.core.cartesian.series.WidthBased maxHeight(Number height) {
     ...
     * Setter for the maximum height.
     */
    public com.anychart.core.cartesian.series.WidthBased maxHeight(String height) {
     ...
     */
    public com.anychart.core.cartesian.series.WidthBased maxLabels(String settings) {
     ...
     * Setter for maximum labels.
     */
    public com.anychart.core.cartesian.series.WidthBased maxLabels(Boolean settings) {
     ...
     */
    public com.anychart.core.cartesian.series.WidthBased maxPointWidth(Number width) {
     ...
     * Setter for the maximum point width.
     */
    public com.anychart.core.cartesian.series.WidthBased maxPointWidth(String width) {
     ...
     */
    public com.anychart.core.cartesian.series.WidthBased maxWidth(Number width) {
     ...
     * Setter for the maximum width.
     */
    public com.anychart.core.cartesian.series.WidthBased maxWidth(String width) {
     ...
     * 
     */
    public com.anychart.core.cartesian.series.WidthBased meta(String key, String value) {
     ...
     */
    public com.anychart.core.cartesian.series.WidthBased minHeight(Number height) {
     ...
     * Setter for the minimum height.
     */
    public com.anychart.core.cartesian.series.WidthBased minHeight(String height) {
     ...
     */
    public com.anychart.core.cartesian.series.WidthBased minLabels(String settings) {
     ...
     * Setter for minimum labels.
     */
    public com.anychart.core.cartesian.series.WidthBased minLabels(Boolean settings) {
     ...
     */
    public com.anychart.core.cartesian.series.WidthBased minPointLength(Number length) {
     ...
     * Setter for the minimum point length.
     */
    public com.anychart.core.cartesian.series.WidthBased minPointLength(String length) {
     ...
     */
    public com.anychart.core.cartesian.series.WidthBased minWidth(Number width) {
     ...
     * Setter for the minimum width.
     */
    public com.anychart.core.cartesian.series.WidthBased minWidth(String width) {
     ...
     * 
     */
    public com.anychart.core.cartesian.series.WidthBased name(String value) {
     ...
     */
    public com.anychart.core.cartesian.series.WidthBased normal(String settings) {
     ...
     */
    public com.anychart.core.cartesian.series.WidthBased pointWidth(Number width) {
     ...
     * Setter for the point width settings.
     */
    public com.anychart.core.cartesian.series.WidthBased pointWidth(String width) {
     ...
     */
    public com.anychart.core.cartesian.series.WidthBased right(Number right) {
     ...
     * Setter for element right bound setting.
     */
    public com.anychart.core.cartesian.series.WidthBased right(String right) {
     ...
     * 
     */
    public com.anychart.core.cartesian.series.WidthBased select(Number index) {
     ...
     * 
     */
    public com.anychart.core.cartesian.series.WidthBased select(Number[] indexes) {
     ...
     */
    public com.anychart.core.cartesian.series.WidthBased selected(String settings) {
...
To select multiple points, press 'ctrl' and click on them.
     */
    public com.anychart.core.cartesian.series.WidthBased selectionMode(com.anychart.enums.SelectionMode value) {
...
To select multiple points, press 'ctrl' and click on them.
     */
    public com.anychart.core.cartesian.series.WidthBased selectionMode(String value) {
     ...
     * 
     */
    public com.anychart.core.cartesian.series.WidthBased tooltip(String value) {
     ...
     * 
     */
    public com.anychart.core.cartesian.series.WidthBased tooltip(Boolean value) {
     ...
     */
    public com.anychart.core.cartesian.series.WidthBased top(Number top) {
     ...
     * Setter for element top bound settings.
     */
    public com.anychart.core.cartesian.series.WidthBased top(String top) {
...
<b>Note:</b> Works only after {@link anychart.charts.Cartesian#draw} is called.
     ...
     */
    public com.anychart.core.cartesian.series.WidthBased unhover(Number indexOrIndexes) {
     ...
     */
    public com.anychart.core.cartesian.series.WidthBased unselect() {
     ...
     */
    public com.anychart.core.cartesian.series.WidthBased unselect(Number index) {
     ...
     */
    public com.anychart.core.cartesian.series.WidthBased unselect(Number[] indexes) {
     ...
     */
    public com.anychart.core.cartesian.series.WidthBased width(Number width) {
     ...
     * Setter for element width setting.
     */
    public com.anychart.core.cartesian.series.WidthBased width(String width) {
     ...
     */
    public com.anychart.core.cartesian.series.WidthBased xPointPosition(Number position) {
     ...
     */
    public com.anychart.core.cartesian.series.WidthBased xScale(com.anychart.scales.Base settings) {
     ...
     * Setter for the series X scale.
     */
    public com.anychart.core.cartesian.series.WidthBased xScale(String settings) {
     ...
     * Setter for the series X scale.
     */
    public com.anychart.core.cartesian.series.WidthBased xScale(com.anychart.enums.ScaleTypes settings) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".xScale(%s);", (settings != null) ? settings.getJsBase() : null));
     ...
     */
    public com.anychart.core.cartesian.series.WidthBased yScale(com.anychart.scales.Base settings) {
     ...
     * Setter for the series Y scale.
     */
    public com.anychart.core.cartesian.series.WidthBased yScale(String settings) {
     ...
     * Setter for the series Y scale.
     */
    public com.anychart.core.cartesian.series.WidthBased yScale(com.anychart.enums.ScaleTypes settings) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".yScale(%s);", (settings != null) ? settings.getJsBase() : null));
     ...
     */
    public com.anychart.core.cartesian.series.WidthBased zIndex(Number zIndex) {
     ...
     */
    public com.anychart.core.cartesian.series.WidthBased colorScale(com.anychart.scales.LinearColor settings) {
     ...
     * Setter for the color scale.
     */
    public com.anychart.core.cartesian.series.WidthBased colorScale(com.anychart.scales.OrdinalColor settings) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".colorScale(%s);", (settings != null) ? settings.getJsBase() : null));
     ...
     * Setter for the color scale.
     */
    public com.anychart.core.cartesian.series.WidthBased colorScale(String settings) {
     ...
     * Setter for the color scale.
     */
    public com.anychart.core.cartesian.series.WidthBased colorScale(com.anychart.enums.ScaleTypes settings) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".colorScale(%s);", (settings != null) ? settings.getJsBase() : null));
...
Set it to null to reset to the default. {docs:Basic_Charts/Vertical/Overview}Learn more about Vertical chart.{docs}
     */
    public com.anychart.core.cartesian.series.WidthBased isVertical(Boolean enabled) {
     ...
     */
    public com.anychart.core.cartesian.series.WidthBased rendering(String settings) {
     ...
     */
    public com.anychart.core.cartesian.series.WidthBased seriesType(String type) {
     ...
     */
    public com.anychart.core.cartesian.series.WidthBased container(com.anychart.graphics.vector.Layer element) {
     ...
     * Setter for the container.
     */
    public com.anychart.core.cartesian.series.WidthBased container(com.anychart.graphics.vector.Stage element) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".container(%s);", (element != null) ? element.getJsBase() : null));
     ...
     * Setter for the container.
     */
    public com.anychart.core.cartesian.series.WidthBased container(String element) {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public com.anychart.core.cartesian.series.WidthBased parentBounds(com.anychart.math.Rect bounds) {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public com.anychart.core.cartesian.series.WidthBased parentBounds(String bounds) {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public com.anychart.core.cartesian.series.WidthBased parentBounds(Number bounds) {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public com.anychart.core.cartesian.series.WidthBased parentBounds(Number left, Number top, Number width, Number height) {
