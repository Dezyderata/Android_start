...
public class Node extends Base {
    ...
    public Node(String jsChart) {
        jsBase = "node" + ++variableIndex;
     ...
     */
    public com.anychart.core.sankey.elements.Node hovered(String value) {
     ...
     */
    public com.anychart.core.sankey.elements.Node normal(String settings) {
     ...
     */
    public com.anychart.core.sankey.elements.Node tooltip(String settings) {
     ...
     * Setter for the tooltip.
     */
    public com.anychart.core.sankey.elements.Node tooltip(Boolean settings) {
