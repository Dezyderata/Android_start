...
public class Dropoff extends Base {
    ...
    public Dropoff(String jsChart) {
        jsBase = "dropoff" + ++variableIndex;
     ...
     */
    public com.anychart.core.sankey.elements.Dropoff hovered(String settings) {
     ...
     */
    public com.anychart.core.sankey.elements.Dropoff normal(String settings) {
     ...
     */
    public com.anychart.core.sankey.elements.Dropoff tooltip(String settings) {
     ...
     * Setter for the dropoff element tooltip.
     */
    public com.anychart.core.sankey.elements.Dropoff tooltip(Boolean settings) {
