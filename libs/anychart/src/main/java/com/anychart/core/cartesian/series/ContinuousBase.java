...
public class ContinuousBase extends BaseWithMarkers {
    ...
    public ContinuousBase(String jsChart) {
        jsBase = "continuousBase" + ++variableIndex;
     ...
     */
    public com.anychart.core.cartesian.series.ContinuousBase a11y(Boolean value) {
     ...
     * Setter for the accessibility setting.
     */
    public com.anychart.core.cartesian.series.ContinuousBase a11y(String value) {
     ...
     */
    public com.anychart.core.cartesian.series.ContinuousBase bottom(Number bottom) {
     ...
     * Setter for element bottom bound settings.
     */
    public com.anychart.core.cartesian.series.ContinuousBase bottom(String bottom) {
     ...
     */
    public com.anychart.core.cartesian.series.ContinuousBase bounds(com.anychart.utils.RectObj bounds) {
     ...
     * Setter for bounds of the element using one parameter.
     */
    public com.anychart.core.cartesian.series.ContinuousBase bounds(com.anychart.math.Rect bounds) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".bounds(%s);", (bounds != null) ? bounds.getJsBase() : null));
     ...
     * Setter for bounds of the element using one parameter.
     */
    public com.anychart.core.cartesian.series.ContinuousBase bounds(com.anychart.core.utils.Bounds bounds) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".bounds(%s);", (bounds != null) ? bounds.getJsBase() : null));
     ...
     */
    public com.anychart.core.cartesian.series.ContinuousBase bounds(Number x, Number y, Number width, Number height) {
     ...
     * Setter for element bounds settings.
     */
    public com.anychart.core.cartesian.series.ContinuousBase bounds(Number x, Number y, Number width, String height) {
     ...
     * Setter for element bounds settings.
     */
    public com.anychart.core.cartesian.series.ContinuousBase bounds(Number x, Number y, String width, Number height) {
     ...
     * Setter for element bounds settings.
     */
    public com.anychart.core.cartesian.series.ContinuousBase bounds(Number x, Number y, String width, String height) {
     ...
     * Setter for element bounds settings.
     */
    public com.anychart.core.cartesian.series.ContinuousBase bounds(Number x, String y, Number width, Number height) {
     ...
     * Setter for element bounds settings.
     */
    public com.anychart.core.cartesian.series.ContinuousBase bounds(Number x, String y, Number width, String height) {
     ...
     * Setter for element bounds settings.
     */
    public com.anychart.core.cartesian.series.ContinuousBase bounds(Number x, String y, String width, Number height) {
     ...
     * Setter for element bounds settings.
     */
    public com.anychart.core.cartesian.series.ContinuousBase bounds(Number x, String y, String width, String height) {
     ...
     * Setter for element bounds settings.
     */
    public com.anychart.core.cartesian.series.ContinuousBase bounds(String x, Number y, Number width, Number height) {
     ...
     * Setter for element bounds settings.
     */
    public com.anychart.core.cartesian.series.ContinuousBase bounds(String x, Number y, Number width, String height) {
     ...
     * Setter for element bounds settings.
     */
    public com.anychart.core.cartesian.series.ContinuousBase bounds(String x, Number y, String width, Number height) {
     ...
     * Setter for element bounds settings.
     */
    public com.anychart.core.cartesian.series.ContinuousBase bounds(String x, Number y, String width, String height) {
     ...
     * Setter for element bounds settings.
     */
    public com.anychart.core.cartesian.series.ContinuousBase bounds(String x, String y, Number width, Number height) {
     ...
     * Setter for element bounds settings.
     */
    public com.anychart.core.cartesian.series.ContinuousBase bounds(String x, String y, Number width, String height) {
     ...
     * Setter for element bounds settings.
     */
    public com.anychart.core.cartesian.series.ContinuousBase bounds(String x, String y, String width, Number height) {
     ...
     * Setter for element bounds settings.
     */
    public com.anychart.core.cartesian.series.ContinuousBase bounds(String x, String y, String width, String height) {
     ...
     */
    public com.anychart.core.cartesian.series.ContinuousBase clip(Boolean value) {
     ...
     * Setter for series clip settings.
     */
    public com.anychart.core.cartesian.series.ContinuousBase clip(com.anychart.math.Rect value) {
     ...
     * 
     */
    public com.anychart.core.cartesian.series.ContinuousBase color(com.anychart.graphics.vector.Fill value) {
     ...
     */
    public com.anychart.core.cartesian.series.ContinuousBase connectMissingPoints(Boolean enabled) {
     ...
     */
    public com.anychart.core.cartesian.series.ContinuousBase enabled(Boolean enabled) {
     ...
     */
    public com.anychart.core.cartesian.series.ContinuousBase error(String settings) {
     ...
     * Setter for the series error.
     */
    public com.anychart.core.cartesian.series.ContinuousBase error(Boolean settings) {
     ...
     * Setter for the series error.
     */
    public com.anychart.core.cartesian.series.ContinuousBase error(Number settings) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".error(%s);", settings));
...
<b>Note:</b> Works only after {@link anychart.charts.Cartesian#draw} is called.
     ...
     */
    public com.anychart.core.cartesian.series.ContinuousBase height(Number height) {
     ...
     * Setter for element height setting.
     */
    public com.anychart.core.cartesian.series.ContinuousBase height(String height) {
     ...
     * Hovers points.
     */
    public com.anychart.core.cartesian.series.ContinuousBase hover() {
     ...
     */
    public com.anychart.core.cartesian.series.ContinuousBase hover(Number index) {
     ...
     */
    public com.anychart.core.cartesian.series.ContinuousBase hover(Number[] indexes) {
     ...
     */
    public com.anychart.core.cartesian.series.ContinuousBase hovered(String settings) {
     ...
     */
    public com.anychart.core.cartesian.series.ContinuousBase id(String id) {
     ...
     * Setter for the series id.
     */
    public com.anychart.core.cartesian.series.ContinuousBase id(Number id) {
     ...
     */
    public com.anychart.core.cartesian.series.ContinuousBase labels(String settings) {
     ...
     * Setter for series data labels.
     */
    public com.anychart.core.cartesian.series.ContinuousBase labels(Boolean settings) {
     ...
     */
    public com.anychart.core.cartesian.series.ContinuousBase left(Number left) {
     ...
     * Setter for element left bound settings.
     */
    public com.anychart.core.cartesian.series.ContinuousBase left(String left) {
     ...
     * 
     */
    public com.anychart.core.cartesian.series.ContinuousBase legendItem(String value) {
     ...
     */
    public com.anychart.core.cartesian.series.ContinuousBase markers(String settings) {
     ...
     * Setter for series data markers.
     */
    public com.anychart.core.cartesian.series.ContinuousBase markers(Boolean settings) {
     ...
     */
    public com.anychart.core.cartesian.series.ContinuousBase maxHeight(Number height) {
     ...
     * Setter for the maximum height.
     */
    public com.anychart.core.cartesian.series.ContinuousBase maxHeight(String height) {
     ...
     */
    public com.anychart.core.cartesian.series.ContinuousBase maxLabels(String settings) {
     ...
     * Setter for maximum labels.
     */
    public com.anychart.core.cartesian.series.ContinuousBase maxLabels(Boolean settings) {
     ...
     */
    public com.anychart.core.cartesian.series.ContinuousBase maxWidth(Number width) {
     ...
     * Setter for the maximum width.
     */
    public com.anychart.core.cartesian.series.ContinuousBase maxWidth(String width) {
     ...
     * 
     */
    public com.anychart.core.cartesian.series.ContinuousBase meta(String key, String value) {
     ...
     */
    public com.anychart.core.cartesian.series.ContinuousBase minHeight(Number height) {
     ...
     * Setter for the minimum height.
     */
    public com.anychart.core.cartesian.series.ContinuousBase minHeight(String height) {
     ...
     */
    public com.anychart.core.cartesian.series.ContinuousBase minLabels(String settings) {
     ...
     * Setter for minimum labels.
     */
    public com.anychart.core.cartesian.series.ContinuousBase minLabels(Boolean settings) {
     ...
     */
    public com.anychart.core.cartesian.series.ContinuousBase minWidth(Number width) {
     ...
     * Setter for the minimum width.
     */
    public com.anychart.core.cartesian.series.ContinuousBase minWidth(String width) {
     ...
     * 
     */
    public com.anychart.core.cartesian.series.ContinuousBase name(String value) {
     ...
     */
    public com.anychart.core.cartesian.series.ContinuousBase normal(String settings) {
     ...
     */
    public com.anychart.core.cartesian.series.ContinuousBase right(Number right) {
     ...
     * Setter for element right bound setting.
     */
    public com.anychart.core.cartesian.series.ContinuousBase right(String right) {
     ...
     * 
     */
    public com.anychart.core.cartesian.series.ContinuousBase select(Number index) {
     ...
     * 
     */
    public com.anychart.core.cartesian.series.ContinuousBase select(Number[] indexes) {
     ...
     */
    public com.anychart.core.cartesian.series.ContinuousBase selected(String settings) {
...
To select multiple points, press 'ctrl' and click on them.
     */
    public com.anychart.core.cartesian.series.ContinuousBase selectionMode(com.anychart.enums.SelectionMode value) {
...
To select multiple points, press 'ctrl' and click on them.
     */
    public com.anychart.core.cartesian.series.ContinuousBase selectionMode(String value) {
     ...
     * 
     */
    public com.anychart.core.cartesian.series.ContinuousBase tooltip(String value) {
     ...
     * 
     */
    public com.anychart.core.cartesian.series.ContinuousBase tooltip(Boolean value) {
     ...
     */
    public com.anychart.core.cartesian.series.ContinuousBase top(Number top) {
     ...
     * Setter for element top bound settings.
     */
    public com.anychart.core.cartesian.series.ContinuousBase top(String top) {
...
<b>Note:</b> Works only after {@link anychart.charts.Cartesian#draw} is called.
     ...
     */
    public com.anychart.core.cartesian.series.ContinuousBase unhover() {
     ...
     */
    public com.anychart.core.cartesian.series.ContinuousBase unselect() {
     ...
     */
    public com.anychart.core.cartesian.series.ContinuousBase unselect(Number index) {
     ...
     */
    public com.anychart.core.cartesian.series.ContinuousBase unselect(Number[] indexes) {
     ...
     */
    public com.anychart.core.cartesian.series.ContinuousBase width(Number width) {
     ...
     * Setter for element width setting.
     */
    public com.anychart.core.cartesian.series.ContinuousBase width(String width) {
     ...
     */
    public com.anychart.core.cartesian.series.ContinuousBase xPointPosition(Number position) {
     ...
     */
    public com.anychart.core.cartesian.series.ContinuousBase xScale(com.anychart.scales.Base settings) {
     ...
     * Setter for the series X scale.
     */
    public com.anychart.core.cartesian.series.ContinuousBase xScale(String settings) {
     ...
     * Setter for the series X scale.
     */
    public com.anychart.core.cartesian.series.ContinuousBase xScale(com.anychart.enums.ScaleTypes settings) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".xScale(%s);", (settings != null) ? settings.getJsBase() : null));
     ...
     */
    public com.anychart.core.cartesian.series.ContinuousBase yScale(com.anychart.scales.Base settings) {
     ...
     * Setter for the series Y scale.
     */
    public com.anychart.core.cartesian.series.ContinuousBase yScale(String settings) {
     ...
     * Setter for the series Y scale.
     */
    public com.anychart.core.cartesian.series.ContinuousBase yScale(com.anychart.enums.ScaleTypes settings) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".yScale(%s);", (settings != null) ? settings.getJsBase() : null));
     ...
     */
    public com.anychart.core.cartesian.series.ContinuousBase zIndex(Number zIndex) {
     ...
     */
    public com.anychart.core.cartesian.series.ContinuousBase colorScale(com.anychart.scales.LinearColor settings) {
     ...
     * Setter for the color scale.
     */
    public com.anychart.core.cartesian.series.ContinuousBase colorScale(com.anychart.scales.OrdinalColor settings) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".colorScale(%s);", (settings != null) ? settings.getJsBase() : null));
     ...
     * Setter for the color scale.
     */
    public com.anychart.core.cartesian.series.ContinuousBase colorScale(String settings) {
     ...
     * Setter for the color scale.
     */
    public com.anychart.core.cartesian.series.ContinuousBase colorScale(com.anychart.enums.ScaleTypes settings) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".colorScale(%s);", (settings != null) ? settings.getJsBase() : null));
...
Set it to null to reset to the default. {docs:Basic_Charts/Vertical/Overview}Learn more about Vertical chart.{docs}
     */
    public com.anychart.core.cartesian.series.ContinuousBase isVertical(Boolean enabled) {
     ...
     */
    public com.anychart.core.cartesian.series.ContinuousBase rendering(String settings) {
     ...
     */
    public com.anychart.core.cartesian.series.ContinuousBase seriesType(String type) {
     ...
     */
    public com.anychart.core.cartesian.series.ContinuousBase container(com.anychart.graphics.vector.Layer element) {
     ...
     * Setter for the container.
     */
    public com.anychart.core.cartesian.series.ContinuousBase container(com.anychart.graphics.vector.Stage element) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".container(%s);", (element != null) ? element.getJsBase() : null));
     ...
     * Setter for the container.
     */
    public com.anychart.core.cartesian.series.ContinuousBase container(String element) {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public com.anychart.core.cartesian.series.ContinuousBase parentBounds(com.anychart.math.Rect bounds) {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public com.anychart.core.cartesian.series.ContinuousBase parentBounds(String bounds) {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public com.anychart.core.cartesian.series.ContinuousBase parentBounds(Number bounds) {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public com.anychart.core.cartesian.series.ContinuousBase parentBounds(Number left, Number top, Number width, Number height) {
