...
public class Flow extends Base {
     ...
     */
    public com.anychart.core.sankey.elements.Flow hovered(String value) {
     ...
     */
    public com.anychart.core.sankey.elements.Flow normal(String settings) {
     ...
     */
    public com.anychart.core.sankey.elements.Flow tooltip(String settings) {
     ...
     * Setter for the tooltip.
     */
    public com.anychart.core.sankey.elements.Flow tooltip(Boolean settings) {
