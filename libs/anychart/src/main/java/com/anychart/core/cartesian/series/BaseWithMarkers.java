...
public class BaseWithMarkers extends Base {
     ...
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers a11y(Boolean value) {
     ...
     * Setter for the accessibility setting.
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers a11y(String value) {
     ...
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers bottom(Number bottom) {
     ...
     * Setter for element bottom bound settings.
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers bottom(String bottom) {
     ...
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers bounds(com.anychart.utils.RectObj bounds) {
     ...
     * Setter for bounds of the element using one parameter.
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers bounds(com.anychart.math.Rect bounds) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".bounds(%s);", (bounds != null) ? bounds.getJsBase() : null));
     ...
     * Setter for bounds of the element using one parameter.
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers bounds(com.anychart.core.utils.Bounds bounds) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".bounds(%s);", (bounds != null) ? bounds.getJsBase() : null));
     ...
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers bounds(Number x, Number y, Number width, Number height) {
     ...
     * Setter for element bounds settings.
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers bounds(Number x, Number y, Number width, String height) {
     ...
     * Setter for element bounds settings.
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers bounds(Number x, Number y, String width, Number height) {
     ...
     * Setter for element bounds settings.
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers bounds(Number x, Number y, String width, String height) {
     ...
     * Setter for element bounds settings.
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers bounds(Number x, String y, Number width, Number height) {
     ...
     * Setter for element bounds settings.
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers bounds(Number x, String y, Number width, String height) {
     ...
     * Setter for element bounds settings.
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers bounds(Number x, String y, String width, Number height) {
     ...
     * Setter for element bounds settings.
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers bounds(Number x, String y, String width, String height) {
     ...
     * Setter for element bounds settings.
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers bounds(String x, Number y, Number width, Number height) {
     ...
     * Setter for element bounds settings.
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers bounds(String x, Number y, Number width, String height) {
     ...
     * Setter for element bounds settings.
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers bounds(String x, Number y, String width, Number height) {
     ...
     * Setter for element bounds settings.
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers bounds(String x, Number y, String width, String height) {
     ...
     * Setter for element bounds settings.
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers bounds(String x, String y, Number width, Number height) {
     ...
     * Setter for element bounds settings.
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers bounds(String x, String y, Number width, String height) {
     ...
     * Setter for element bounds settings.
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers bounds(String x, String y, String width, Number height) {
     ...
     * Setter for element bounds settings.
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers bounds(String x, String y, String width, String height) {
     ...
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers clip(Boolean value) {
     ...
     * Setter for series clip settings.
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers clip(com.anychart.math.Rect value) {
     ...
     * 
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers color(com.anychart.graphics.vector.Fill value) {
     ...
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers enabled(Boolean enabled) {
     ...
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers error(String settings) {
     ...
     * Setter for the series error.
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers error(Boolean settings) {
     ...
     * Setter for the series error.
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers error(Number settings) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".error(%s);", settings));
...
<b>Note:</b> Works only after {@link anychart.charts.Cartesian#draw} is called.
     ...
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers height(Number height) {
     ...
     * Setter for element height setting.
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers height(String height) {
     ...
     * Hovers points.
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers hover() {
     ...
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers hover(Number index) {
     ...
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers hover(Number[] indexes) {
     ...
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers hovered(String settings) {
     ...
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers id(String id) {
     ...
     * Setter for the series id.
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers id(Number id) {
     ...
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers labels(String settings) {
     ...
     * Setter for series data labels.
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers labels(Boolean settings) {
     ...
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers left(Number left) {
     ...
     * Setter for element left bound settings.
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers left(String left) {
     ...
     * 
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers legendItem(String value) {
     ...
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers markers(String settings) {
     ...
     * Setter for series data markers.
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers markers(Boolean settings) {
     ...
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers maxHeight(Number height) {
     ...
     * Setter for the maximum height.
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers maxHeight(String height) {
     ...
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers maxLabels(String settings) {
     ...
     * Setter for maximum labels.
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers maxLabels(Boolean settings) {
     ...
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers maxWidth(Number width) {
     ...
     * Setter for the maximum width.
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers maxWidth(String width) {
     ...
     * 
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers meta(String key, String value) {
     ...
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers minHeight(Number height) {
     ...
     * Setter for the minimum height.
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers minHeight(String height) {
     ...
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers minLabels(String settings) {
     ...
     * Setter for minimum labels.
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers minLabels(Boolean settings) {
     ...
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers minWidth(Number width) {
     ...
     * Setter for the minimum width.
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers minWidth(String width) {
     ...
     * 
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers name(String value) {
     ...
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers normal(String settings) {
     ...
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers right(Number right) {
     ...
     * Setter for element right bound setting.
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers right(String right) {
     ...
     * 
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers select(Number index) {
     ...
     * 
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers select(Number[] indexes) {
     ...
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers selected(String settings) {
...
To select multiple points, press 'ctrl' and click on them.
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers selectionMode(com.anychart.enums.SelectionMode value) {
...
To select multiple points, press 'ctrl' and click on them.
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers selectionMode(String value) {
     ...
     * 
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers tooltip(String value) {
     ...
     * 
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers tooltip(Boolean value) {
     ...
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers top(Number top) {
     ...
     * Setter for element top bound settings.
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers top(String top) {
...
<b>Note:</b> Works only after {@link anychart.charts.Cartesian#draw} is called.
     ...
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers unhover(Number indexOrIndexes) {
     ...
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers unselect() {
     ...
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers unselect(Number index) {
     ...
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers unselect(Number[] indexes) {
     ...
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers width(Number width) {
     ...
     * Setter for element width setting.
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers width(String width) {
     ...
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers xPointPosition(Number position) {
     ...
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers xScale(com.anychart.scales.Base settings) {
     ...
     * Setter for the series X scale.
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers xScale(String settings) {
     ...
     * Setter for the series X scale.
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers xScale(com.anychart.enums.ScaleTypes settings) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".xScale(%s);", (settings != null) ? settings.getJsBase() : null));
     ...
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers yScale(com.anychart.scales.Base settings) {
     ...
     * Setter for the series Y scale.
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers yScale(String settings) {
     ...
     * Setter for the series Y scale.
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers yScale(com.anychart.enums.ScaleTypes settings) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".yScale(%s);", (settings != null) ? settings.getJsBase() : null));
     ...
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers zIndex(Number zIndex) {
     ...
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers colorScale(com.anychart.scales.LinearColor settings) {
     ...
     * Setter for the color scale.
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers colorScale(com.anychart.scales.OrdinalColor settings) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".colorScale(%s);", (settings != null) ? settings.getJsBase() : null));
     ...
     * Setter for the color scale.
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers colorScale(String settings) {
     ...
     * Setter for the color scale.
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers colorScale(com.anychart.enums.ScaleTypes settings) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".colorScale(%s);", (settings != null) ? settings.getJsBase() : null));
...
Set it to null to reset to the default. {docs:Basic_Charts/Vertical/Overview}Learn more about Vertical chart.{docs}
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers isVertical(Boolean enabled) {
     ...
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers rendering(String settings) {
     ...
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers seriesType(String type) {
     ...
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers container(com.anychart.graphics.vector.Layer element) {
     ...
     * Setter for the container.
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers container(com.anychart.graphics.vector.Stage element) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".container(%s);", (element != null) ? element.getJsBase() : null));
     ...
     * Setter for the container.
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers container(String element) {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers parentBounds(com.anychart.math.Rect bounds) {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers parentBounds(String bounds) {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers parentBounds(Number bounds) {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public com.anychart.core.cartesian.series.BaseWithMarkers parentBounds(Number left, Number top, Number width, Number height) {
