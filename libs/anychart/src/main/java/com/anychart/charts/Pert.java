...
public class Pert extends SeparateChart {
     ...
     */
    public com.anychart.charts.Pert a11y(Boolean settings) {
     ...
     * Setter for the accessibility setting.
     */
    public com.anychart.charts.Pert a11y(String settings) {
     ...
     */
    public com.anychart.charts.Pert animation(Boolean settings) {
     ...
     * Setter for animation settings by one value.
     */
    public com.anychart.charts.Pert animation(String settings) {
     ...
     */
    public com.anychart.charts.Pert animation(Boolean enabled, Number duration) {
...
Flag whether to automatically call chart.draw() on any changes or not.
     */
    public com.anychart.charts.Pert autoRedraw(Boolean enabled) {
     ...
     */
    public com.anychart.charts.Pert background(String settings) {
     ...
     */
    public com.anychart.charts.Pert bottom(Number bottom) {
     ...
     * Setter for element bottom bound settings.
     */
    public com.anychart.charts.Pert bottom(String bottom) {
     ...
     */
    public com.anychart.charts.Pert bounds(com.anychart.utils.RectObj bounds) {
     ...
     * Setter for bounds of the element using one parameter.
     */
    public com.anychart.charts.Pert bounds(com.anychart.math.Rect bounds) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".bounds(%s);", (bounds != null) ? bounds.getJsBase() : null));
     ...
     * Setter for bounds of the element using one parameter.
     */
    public com.anychart.charts.Pert bounds(com.anychart.core.utils.Bounds bounds) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".bounds(%s);", (bounds != null) ? bounds.getJsBase() : null));
     ...
     */
    public com.anychart.charts.Pert bounds(Number x, Number y, Number width, Number height) {
     ...
     * Setter for element bounds settings.
     */
    public com.anychart.charts.Pert bounds(Number x, Number y, Number width, String height) {
     ...
     * Setter for element bounds settings.
     */
    public com.anychart.charts.Pert bounds(Number x, Number y, String width, Number height) {
     ...
     * Setter for element bounds settings.
     */
    public com.anychart.charts.Pert bounds(Number x, Number y, String width, String height) {
     ...
     * Setter for element bounds settings.
     */
    public com.anychart.charts.Pert bounds(Number x, String y, Number width, Number height) {
     ...
     * Setter for element bounds settings.
     */
    public com.anychart.charts.Pert bounds(Number x, String y, Number width, String height) {
     ...
     * Setter for element bounds settings.
     */
    public com.anychart.charts.Pert bounds(Number x, String y, String width, Number height) {
     ...
     * Setter for element bounds settings.
     */
    public com.anychart.charts.Pert bounds(Number x, String y, String width, String height) {
     ...
     * Setter for element bounds settings.
     */
    public com.anychart.charts.Pert bounds(String x, Number y, Number width, Number height) {
     ...
     * Setter for element bounds settings.
     */
    public com.anychart.charts.Pert bounds(String x, Number y, Number width, String height) {
     ...
     * Setter for element bounds settings.
     */
    public com.anychart.charts.Pert bounds(String x, Number y, String width, Number height) {
     ...
     * Setter for element bounds settings.
     */
    public com.anychart.charts.Pert bounds(String x, Number y, String width, String height) {
     ...
     * Setter for element bounds settings.
     */
    public com.anychart.charts.Pert bounds(String x, String y, Number width, Number height) {
     ...
     * Setter for element bounds settings.
     */
    public com.anychart.charts.Pert bounds(String x, String y, Number width, String height) {
     ...
     * Setter for element bounds settings.
     */
    public com.anychart.charts.Pert bounds(String x, String y, String width, Number height) {
     ...
     * Setter for element bounds settings.
     */
    public com.anychart.charts.Pert bounds(String x, String y, String width, String height) {
     ...
     */
    public com.anychart.charts.Pert cancelMarquee() {
     ...
     */
    public com.anychart.charts.Pert container(com.anychart.graphics.vector.Layer element) {
     ...
     * Setter for the element's container.
     */
    public com.anychart.charts.Pert container(com.anychart.graphics.vector.Stage element) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".container(%s);", (element != null) ? element.getJsBase() : null));
     ...
     * Setter for the element's container.
     */
    public com.anychart.charts.Pert container(String element) {
     ...
     */
    public com.anychart.charts.Pert contextMenu(String settings) {
     ...
     * Setter for the context menu.
     */
    public com.anychart.charts.Pert contextMenu(Boolean settings) {
...
{docs:Quick_Start/Credits}Learn more about credits settings.{docs}
     */
    public com.anychart.charts.Pert credits(String value) {
...
{docs:Quick_Start/Credits}Learn more about credits settings.{docs}
     */
    public com.anychart.charts.Pert credits(Boolean value) {
     ...
     */
    public com.anychart.core.pert.CriticalPath criticalPath() {
        return new com.anychart.core.pert.CriticalPath(jsBase + ".criticalPath()");
    }
    /**
     * Setter for the critical path settings.
     */
    public com.anychart.charts.Pert criticalPath(String settings) {
     ...
     */
    public com.anychart.charts.Pert draw(Boolean async) {
     ...
     */
    public com.anychart.charts.Pert enabled(Boolean enabled) {
     ...
     */
    public com.anychart.charts.Pert exports(String settings) {
     ...
     */
    public com.anychart.charts.Pert fullScreen(Boolean enabled) {
...
<b>Note:</b> Works only after {@link anychart.core.Chart#draw} is called.
     ...
     */
    public com.anychart.charts.Pert height(Number height) {
     ...
     * Setter for element height setting.
     */
    public com.anychart.charts.Pert height(String height) {
     ...
     */
    public com.anychart.charts.Pert horizontalSpacing(Number spacing) {
     ...
     * Setter for milestones horizontal spacing.
     */
    public com.anychart.charts.Pert horizontalSpacing(String spacing) {
     ...
     * Setter for chart id.
     */
    public com.anychart.charts.Pert id(String id) {
     ...
     */
    public com.anychart.charts.Pert interactivity(String settings) {
     ...
     * Setter for interactivity settings for the chart.
     */
    public com.anychart.charts.Pert interactivity(com.anychart.enums.HoverMode settings) {
     ...
     */
    public com.anychart.charts.Pert label(Boolean settings) {
     ...
     * Setter for the chart label.
     */
    public com.anychart.charts.Pert label(String index, Boolean settings) {
     ...
     * Setter for the chart label.
     */
    public com.anychart.charts.Pert label(String index, String settings) {
     ...
     * Setter for the chart label.
     */
    public com.anychart.charts.Pert label(Number index, Boolean settings) {
     ...
     * Setter for the chart label.
     */
    public com.anychart.charts.Pert label(Number index, String settings) {
     ...
     */
    public com.anychart.charts.Pert left(Number left) {
     ...
     * Setter for element left bound settings.
     */
    public com.anychart.charts.Pert left(String left) {
     ...
     */
    public com.anychart.charts.Pert legend(String settings) {
     ...
     * Setter for chart legend settings.
     */
    public com.anychart.charts.Pert legend(Boolean settings) {
...
<img src='/si/8.4.0/anychart.core.Chart.prototype.margin.png' width='352' height='351'/>
     ...
     */
    public com.anychart.charts.Pert margin(Number[] margin) {
     ...
     * Setter for the chart margin in pixels using a single complex object.
     */
    public com.anychart.charts.Pert margin(String[] margin) {
     ...
     */
    public com.anychart.charts.Pert margin(String value1, String value2, String value3, String value4) {
     ...
     * Setter for the chart margin in pixels using several simple values.
     */
    public com.anychart.charts.Pert margin(String value1, String value2, String value3, Number value4) {
     ...
     * Setter for the chart margin in pixels using several simple values.
     */
    public com.anychart.charts.Pert margin(String value1, String value2, Number value3, String value4) {
     ...
     * Setter for the chart margin in pixels using several simple values.
     */
    public com.anychart.charts.Pert margin(String value1, String value2, Number value3, Number value4) {
     ...
     * Setter for the chart margin in pixels using several simple values.
     */
    public com.anychart.charts.Pert margin(String value1, Number value2, String value3, String value4) {
     ...
     * Setter for the chart margin in pixels using several simple values.
     */
    public com.anychart.charts.Pert margin(String value1, Number value2, String value3, Number value4) {
     ...
     * Setter for the chart margin in pixels using several simple values.
     */
    public com.anychart.charts.Pert margin(String value1, Number value2, Number value3, String value4) {
     ...
     * Setter for the chart margin in pixels using several simple values.
     */
    public com.anychart.charts.Pert margin(String value1, Number value2, Number value3, Number value4) {
     ...
     * Setter for the chart margin in pixels using several simple values.
     */
    public com.anychart.charts.Pert margin(Number value1, String value2, String value3, String value4) {
     ...
     * Setter for the chart margin in pixels using several simple values.
     */
    public com.anychart.charts.Pert margin(Number value1, String value2, String value3, Number value4) {
     ...
     * Setter for the chart margin in pixels using several simple values.
     */
    public com.anychart.charts.Pert margin(Number value1, String value2, Number value3, String value4) {
     ...
     * Setter for the chart margin in pixels using several simple values.
     */
    public com.anychart.charts.Pert margin(Number value1, String value2, Number value3, Number value4) {
     ...
     * Setter for the chart margin in pixels using several simple values.
     */
    public com.anychart.charts.Pert margin(Number value1, Number value2, String value3, String value4) {
     ...
     * Setter for the chart margin in pixels using several simple values.
     */
    public com.anychart.charts.Pert margin(Number value1, Number value2, String value3, Number value4) {
     ...
     * Setter for the chart margin in pixels using several simple values.
     */
    public com.anychart.charts.Pert margin(Number value1, Number value2, Number value3, String value4) {
     ...
     * Setter for the chart margin in pixels using several simple values.
     */
    public com.anychart.charts.Pert margin(Number value1, Number value2, Number value3, Number value4) {
     ...
     */
    public com.anychart.charts.Pert maxHeight(Number height) {
     ...
     * Setter for the maximum height.
     */
    public com.anychart.charts.Pert maxHeight(String height) {
     ...
     */
    public com.anychart.charts.Pert maxWidth(Number width) {
     ...
     * Setter for the maximum width.
     */
    public com.anychart.charts.Pert maxWidth(String width) {
     ...
     */
    public com.anychart.core.pert.Milestones milestones() {
        return new com.anychart.core.pert.Milestones(jsBase + ".milestones()");
    }
    /**
     * Setter for milestones settings object.
     */
    public com.anychart.charts.Pert milestones(String settings) {
     ...
     */
    public com.anychart.charts.Pert minHeight(Number height) {
     ...
     * Setter for the minimum height.
     */
    public com.anychart.charts.Pert minHeight(String height) {
     ...
     */
    public com.anychart.charts.Pert minWidth(Number width) {
     ...
     * Setter for the minimum width.
     */
    public com.anychart.charts.Pert minWidth(String width) {
...
{docs:Working_with_Data/No_Data_Label} Learn more about "No data" feature {docs}
     */
    public com.anychart.charts.Pert noData(String settings) {
...
<img src='/si/8.4.0/anychart.core.Chart.prototype.padding.png' width='352' height='351'/>
     ...
     */
    public com.anychart.charts.Pert padding(Number[] padding) {
     ...
     * Setter for the chart paddings in pixels using a single value.
     */
    public com.anychart.charts.Pert padding(String[] padding) {
     ...
     */
    public com.anychart.charts.Pert padding(String value1, String value2, String value3, String value4) {
     ...
     * Setter for the chart paddings in pixels using several numbers.
     */
    public com.anychart.charts.Pert padding(String value1, String value2, String value3, Number value4) {
     ...
     * Setter for the chart paddings in pixels using several numbers.
     */
    public com.anychart.charts.Pert padding(String value1, String value2, Number value3, String value4) {
     ...
     * Setter for the chart paddings in pixels using several numbers.
     */
    public com.anychart.charts.Pert padding(String value1, String value2, Number value3, Number value4) {
     ...
     * Setter for the chart paddings in pixels using several numbers.
     */
    public com.anychart.charts.Pert padding(String value1, Number value2, String value3, String value4) {
     ...
     * Setter for the chart paddings in pixels using several numbers.
     */
    public com.anychart.charts.Pert padding(String value1, Number value2, String value3, Number value4) {
     ...
     * Setter for the chart paddings in pixels using several numbers.
     */
    public com.anychart.charts.Pert padding(String value1, Number value2, Number value3, String value4) {
     ...
     * Setter for the chart paddings in pixels using several numbers.
     */
    public com.anychart.charts.Pert padding(String value1, Number value2, Number value3, Number value4) {
     ...
     * Setter for the chart paddings in pixels using several numbers.
     */
    public com.anychart.charts.Pert padding(Number value1, String value2, String value3, String value4) {
     ...
     * Setter for the chart paddings in pixels using several numbers.
     */
    public com.anychart.charts.Pert padding(Number value1, String value2, String value3, Number value4) {
     ...
     * Setter for the chart paddings in pixels using several numbers.
     */
    public com.anychart.charts.Pert padding(Number value1, String value2, Number value3, String value4) {
     ...
     * Setter for the chart paddings in pixels using several numbers.
     */
    public com.anychart.charts.Pert padding(Number value1, String value2, Number value3, Number value4) {
     ...
     * Setter for the chart paddings in pixels using several numbers.
     */
    public com.anychart.charts.Pert padding(Number value1, Number value2, String value3, String value4) {
     ...
     * Setter for the chart paddings in pixels using several numbers.
     */
    public com.anychart.charts.Pert padding(Number value1, Number value2, String value3, Number value4) {
     ...
     * Setter for the chart paddings in pixels using several numbers.
     */
    public com.anychart.charts.Pert padding(Number value1, Number value2, Number value3, String value4) {
     ...
     * Setter for the chart paddings in pixels using several numbers.
     */
    public com.anychart.charts.Pert padding(Number value1, Number value2, Number value3, Number value4) {
     ...
     */
    public com.anychart.charts.Pert right(Number right) {
     ...
     * Setter for element right bound setting.
     */
    public com.anychart.charts.Pert right(String right) {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public com.anychart.charts.Pert selectMarqueeFill(com.anychart.graphics.vector.Fill color) {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public com.anychart.charts.Pert selectMarqueeFill(com.anychart.graphics.vector.GradientKey color) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".selectMarqueeFill(%s);", (color != null) ? color.getJsBase() : null));
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public com.anychart.charts.Pert selectMarqueeFill(String[] color) {
     ...
     */
    public com.anychart.charts.Pert selectMarqueeFill(String color, Number opacity) {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public com.anychart.charts.Pert selectMarqueeFill(com.anychart.graphics.vector.GradientKey keys, Number angle, Boolean mode, Number opacity) {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public com.anychart.charts.Pert selectMarqueeFill(com.anychart.graphics.vector.GradientKey keys, Number angle, com.anychart.graphics.vector.Rect mode, Number opacity) {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public com.anychart.charts.Pert selectMarqueeFill(com.anychart.graphics.vector.GradientKey keys, Number angle, String mode, Number opacity) {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public com.anychart.charts.Pert selectMarqueeFill(String[] keys, Number angle, Boolean mode, Number opacity) {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public com.anychart.charts.Pert selectMarqueeFill(String[] keys, Number angle, com.anychart.graphics.vector.Rect mode, Number opacity) {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public com.anychart.charts.Pert selectMarqueeFill(String[] keys, Number angle, String mode, Number opacity) {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public com.anychart.charts.Pert selectMarqueeFill(com.anychart.graphics.vector.GradientKey keys, Number cx, Number cy, com.anychart.graphics.math.Rect mode, Number opacity, Number fx, Number fy) {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public com.anychart.charts.Pert selectMarqueeFill(String[] keys, Number cx, Number cy, com.anychart.graphics.math.Rect mode, Number opacity, Number fx, Number fy) {
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public com.anychart.charts.Pert selectMarqueeStroke(com.anychart.graphics.vector.Stroke color, Number thickness, String dashpattern, String lineJoin, String lineCap) {
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public com.anychart.charts.Pert selectMarqueeStroke(com.anychart.graphics.vector.Stroke color, Number thickness, String dashpattern, String lineJoin, com.anychart.graphics.vector.StrokeLineCap lineCap) {
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public com.anychart.charts.Pert selectMarqueeStroke(com.anychart.graphics.vector.Stroke color, Number thickness, String dashpattern, com.anychart.graphics.vector.StrokeLineJoin lineJoin, String lineCap) {
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public com.anychart.charts.Pert selectMarqueeStroke(com.anychart.graphics.vector.Stroke color, Number thickness, String dashpattern, com.anychart.graphics.vector.StrokeLineJoin lineJoin, com.anychart.graphics.vector.StrokeLineCap lineCap) {
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public com.anychart.charts.Pert selectMarqueeStroke(com.anychart.graphics.vector.ColoredFill color, Number thickness, String dashpattern, String lineJoin, String lineCap) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".selectMarqueeStroke(%s, %s, %s, %s, %s);", (color != null) ? color.getJsBase() : null, thickness, wrapQuotes(dashpattern), wrapQuotes(lineJoin), wrapQuotes(lineCap)));
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public com.anychart.charts.Pert selectMarqueeStroke(com.anychart.graphics.vector.ColoredFill color, Number thickness, String dashpattern, String lineJoin, com.anychart.graphics.vector.StrokeLineCap lineCap) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".selectMarqueeStroke(%s, %s, %s, %s, %s);", (color != null) ? color.getJsBase() : null, thickness, wrapQuotes(dashpattern), wrapQuotes(lineJoin), (lineCap != null) ? lineCap.getJsBase() : null));
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public com.anychart.charts.Pert selectMarqueeStroke(com.anychart.graphics.vector.ColoredFill color, Number thickness, String dashpattern, com.anychart.graphics.vector.StrokeLineJoin lineJoin, String lineCap) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".selectMarqueeStroke(%s, %s, %s, %s, %s);", (color != null) ? color.getJsBase() : null, thickness, wrapQuotes(dashpattern), (lineJoin != null) ? lineJoin.getJsBase() : null, wrapQuotes(lineCap)));
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public com.anychart.charts.Pert selectMarqueeStroke(com.anychart.graphics.vector.ColoredFill color, Number thickness, String dashpattern, com.anychart.graphics.vector.StrokeLineJoin lineJoin, com.anychart.graphics.vector.StrokeLineCap lineCap) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".selectMarqueeStroke(%s, %s, %s, %s, %s);", (color != null) ? color.getJsBase() : null, thickness, wrapQuotes(dashpattern), (lineJoin != null) ? lineJoin.getJsBase() : null, (lineCap != null) ? lineCap.getJsBase() : null));
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public com.anychart.charts.Pert selectMarqueeStroke(String color, Number thickness, String dashpattern, String lineJoin, String lineCap) {
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public com.anychart.charts.Pert selectMarqueeStroke(String color, Number thickness, String dashpattern, String lineJoin, com.anychart.graphics.vector.StrokeLineCap lineCap) {
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public com.anychart.charts.Pert selectMarqueeStroke(String color, Number thickness, String dashpattern, com.anychart.graphics.vector.StrokeLineJoin lineJoin, String lineCap) {
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public com.anychart.charts.Pert selectMarqueeStroke(String color, Number thickness, String dashpattern, com.anychart.graphics.vector.StrokeLineJoin lineJoin, com.anychart.graphics.vector.StrokeLineCap lineCap) {
...
<b>Note:</b> Works only after {@link anychart.core.Chart#draw} is called.
     */
    public com.anychart.charts.Pert startSelectMarquee(Boolean repeat) {
     ...
     */
    public com.anychart.core.pert.Tasks tasks() {
        return new com.anychart.core.pert.Tasks(jsBase + ".tasks()");
    }
    /**
     * Setter for the tasks settings.
     */
    public com.anychart.charts.Pert tasks(String settings) {
     ...
     */
    public com.anychart.charts.Pert title(Boolean settings) {
     ...
     * Setter for the chart title.
     */
    public com.anychart.charts.Pert title(String settings) {
     ...
     */
    public com.anychart.charts.Pert top(Number top) {
     ...
     * Setter for element top bound settings.
     */
    public com.anychart.charts.Pert top(String top) {
     ...
     */
    public com.anychart.charts.Pert verticalSpacing(Number settings) {
     ...
     * Setter for milestones vertical spacing.
     */
    public com.anychart.charts.Pert verticalSpacing(String settings) {
     ...
     */
    public com.anychart.charts.Pert width(Number width) {
     ...
     * Setter for element width setting.
     */
    public com.anychart.charts.Pert width(String width) {
     ...
     */
    public com.anychart.charts.Pert zIndex(Number zIndex) {
     ...
     */
    public com.anychart.charts.Pert tooltip(String settings) {
     ...
     * Setter for the chart tooltip.
     */
    public com.anychart.charts.Pert tooltip(Boolean settings) {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public com.anychart.charts.Pert parentBounds(com.anychart.math.Rect bounds) {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public com.anychart.charts.Pert parentBounds(String bounds) {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public com.anychart.charts.Pert parentBounds(Number bounds) {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public com.anychart.charts.Pert parentBounds(Number left, Number top, Number width, Number height) {
