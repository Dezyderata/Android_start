...
public class TreeMap extends SeparateChart {
     ...
     */
    public com.anychart.charts.TreeMap a11y(Boolean settings) {
     ...
     * Setter for the accessibility setting.
     */
    public com.anychart.charts.TreeMap a11y(String settings) {
     ...
     */
    public com.anychart.charts.TreeMap animation(Boolean settings) {
     ...
     * Setter for animation settings by one value.
     */
    public com.anychart.charts.TreeMap animation(String settings) {
...
Flag whether to automatically call chart.draw() on any changes or not.
     */
    public com.anychart.charts.TreeMap autoRedraw(Boolean enabled) {
     ...
     */
    public com.anychart.charts.TreeMap background(String settings) {
     ...
     */
    public com.anychart.charts.TreeMap bottom(Number bottom) {
     ...
     * Setter for element bottom bound settings.
     */
    public com.anychart.charts.TreeMap bottom(String bottom) {
     ...
     */
    public com.anychart.charts.TreeMap bounds(com.anychart.utils.RectObj bounds) {
     ...
     * Setter for bounds of the element using one parameter.
     */
    public com.anychart.charts.TreeMap bounds(com.anychart.math.Rect bounds) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".bounds(%s);", (bounds != null) ? bounds.getJsBase() : null));
     ...
     * Setter for bounds of the element using one parameter.
     */
    public com.anychart.charts.TreeMap bounds(com.anychart.core.utils.Bounds bounds) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".bounds(%s);", (bounds != null) ? bounds.getJsBase() : null));
     ...
     */
    public com.anychart.charts.TreeMap colorRange(String settings) {
     ...
     */
    public com.anychart.scales.LinearColor colorScale(com.anychart.scales.OrdinalColor settings) {
        return new com.anychart.scales.LinearColor(String.format(Locale.US, jsBase + ".colorScale(%s)", (settings != null) ? settings.getJsBase() : null));
    }
    /**
     * Setter for the color scale.
     */
    public com.anychart.scales.LinearColor colorScale(com.anychart.scales.LinearColor settings) {
        return new com.anychart.scales.LinearColor(String.format(Locale.US, jsBase + ".colorScale(%s)", (settings != null) ? settings.getJsBase() : null));
    }
    /**
     * Setter for the color scale.
     */
    public com.anychart.scales.LinearColor colorScale(String settings) {
        return new com.anychart.scales.LinearColor(String.format(Locale.US, jsBase + ".colorScale(%s)", wrapQuotes(settings)));
    }
    /**
     * Setter for the color scale.
     */
    public com.anychart.scales.LinearColor colorScale(com.anychart.enums.ScaleTypes settings) {
        return new com.anychart.scales.LinearColor(String.format(Locale.US, jsBase + ".colorScale(%s)", (settings != null) ? settings.getJsBase() : null));
    }
    /**
     ...
     */
    public com.anychart.charts.TreeMap container(com.anychart.graphics.vector.Layer element) {
     ...
     * Setter for the element's container.
     */
    public com.anychart.charts.TreeMap container(com.anychart.graphics.vector.Stage element) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".container(%s);", (element != null) ? element.getJsBase() : null));
     ...
     * Setter for the element's container.
     */
    public com.anychart.charts.TreeMap container(String element) {
...
{docs:Quick_Start/Credits}Learn more about credits settings.{docs}
     ...
     */
    public com.anychart.charts.TreeMap enabled(Boolean enabled) {
     ...
     */
    public com.anychart.charts.TreeMap exports(String settings) {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public com.anychart.charts.TreeMap fill(com.anychart.graphics.vector.Fill color) {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public com.anychart.charts.TreeMap fill(com.anychart.graphics.vector.GradientKey color) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".fill(%s);", (color != null) ? color.getJsBase() : null));
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public com.anychart.charts.TreeMap fill(String[] color) {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     ...
     */
    public com.anychart.charts.TreeMap fullScreen(Boolean enabled) {
...
<b>Note:</b> Works only after {@link anychart.core.Chart#draw} is called.
     ...
     */
    public com.anychart.charts.TreeMap hatchFill(com.anychart.graphics.vector.hatchfill.HatchFillType type, String color, Number thickness, Number size) {
     ...
     * Setter for the hatch fill settings.
     */
    public com.anychart.charts.TreeMap hatchFill(String type, String color, Number thickness, Number size) {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public com.anychart.charts.TreeMap hatchFill(String hatchFillFunction) {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public com.anychart.charts.TreeMap hatchFill(com.anychart.graphics.vector.PatternFill patternFill) {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public com.anychart.charts.TreeMap hatchFill(com.anychart.graphics.vector.HatchFill settings) {
...
{docs:Graphics/Hatch_Fill_Settings}Learn more about hatch fill settings.{docs}
     */
    public com.anychart.charts.TreeMap hatchFill(Boolean enabled) {
     ...
     */
    public com.anychart.charts.TreeMap headers(String settings) {
     ...
     * Setter for the point header labels.
     */
    public com.anychart.charts.TreeMap headers(Boolean settings) {
     ...
     */
    public com.anychart.charts.TreeMap headersDisplayMode(com.anychart.enums.LabelsDisplayMode mode) {
     ...
     * Setter for the headers display mode.
     */
    public com.anychart.charts.TreeMap headersDisplayMode(String mode) {
     ...
     */
    public com.anychart.charts.TreeMap height(Number height) {
     ...
     * Setter for element height setting.
     */
    public com.anychart.charts.TreeMap height(String height) {
     ...
     */
    public com.anychart.charts.TreeMap hintDepth(Number hintDepth) {
     ...
     */
    public com.anychart.charts.TreeMap hintOpacity(Number hintOpacity) {
     ...
     */
    public com.anychart.charts.TreeMap hovered(String settings) {
     ...
     * Setter for chart id.
     */
    public com.anychart.charts.TreeMap id(String id) {
     ...
     */
    public com.anychart.charts.TreeMap interactivity(String settings) {
     ...
     * Setter for interactivity settings for the chart.
     */
    public com.anychart.charts.TreeMap interactivity(com.anychart.enums.HoverMode settings) {
     ...
     */
    public com.anychart.charts.TreeMap label(Boolean settings) {
     ...
     * Setter for the chart label.
     */
    public com.anychart.charts.TreeMap label(String index, Boolean settings) {
     ...
     * Setter for the chart label.
     */
    public com.anychart.charts.TreeMap label(String index, String settings) {
     ...
     * Setter for the chart label.
     */
    public com.anychart.charts.TreeMap label(Number index, Boolean settings) {
     ...
     * Setter for the chart label.
     */
    public com.anychart.charts.TreeMap label(Number index, String settings) {
     ...
     */
    public com.anychart.charts.TreeMap labels(String settings) {
     ...
     * Setter for the point labels.
     */
    public com.anychart.charts.TreeMap labels(Boolean settings) {
     ...
     */
    public com.anychart.charts.TreeMap labelsDisplayMode(com.anychart.enums.LabelsDisplayMode mode) {
     ...
     * Setter for the labels display mode.
     */
    public com.anychart.charts.TreeMap labelsDisplayMode(String mode) {
     ...
     */
    public com.anychart.charts.TreeMap left(Number left) {
     ...
     * Setter for element left bound settings.
     */
    public com.anychart.charts.TreeMap left(String left) {
     ...
     */
    public com.anychart.charts.TreeMap legend(String settings) {
     ...
     * Setter for chart legend settings.
     */
    public com.anychart.charts.TreeMap legend(Boolean settings) {
...
<img src='/si/8.4.0/anychart.core.Chart.prototype.margin.png' width='352' height='351'/>
     ...
     */
    public com.anychart.charts.TreeMap margin(Number[] margin) {
     ...
     * Setter for the chart margin in pixels using a single complex object.
     */
    public com.anychart.charts.TreeMap margin(String[] margin) {
     ...
     */
    public com.anychart.charts.TreeMap markers(String settings) {
     ...
     * Setter for point markers.
     */
    public com.anychart.charts.TreeMap markers(Boolean settings) {
     ...
     */
    public com.anychart.charts.TreeMap maxDepth(Number maxDepth) {
     ...
     */
    public com.anychart.charts.TreeMap maxHeadersHeight(Number height) {
     ...
     * Setter for the maximum headers height.
     */
    public com.anychart.charts.TreeMap maxHeadersHeight(String height) {
     ...
     */
    public com.anychart.charts.TreeMap maxHeight(Number height) {
     ...
     * Setter for the maximum height.
     */
    public com.anychart.charts.TreeMap maxHeight(String height) {
     ...
     */
    public com.anychart.charts.TreeMap maxWidth(Number width) {
     ...
     * Setter for the maximum width.
     */
    public com.anychart.charts.TreeMap maxWidth(String width) {
     ...
     */
    public com.anychart.charts.TreeMap minHeight(Number height) {
     ...
     * Setter for the minimum height.
     */
    public com.anychart.charts.TreeMap minHeight(String height) {
     ...
     */
    public com.anychart.charts.TreeMap minWidth(Number width) {
     ...
     * Setter for the minimum width.
     */
    public com.anychart.charts.TreeMap minWidth(String width) {
...
{docs:Working_with_Data/No_Data_Label} Learn more about "No data" feature {docs}
     */
    public com.anychart.charts.TreeMap noData(String settings) {
     ...
     */
    public com.anychart.charts.TreeMap normal(String settings) {
...
<img src='/si/8.4.0/anychart.core.Chart.prototype.padding.png' width='352' height='351'/>
     ...
     */
    public com.anychart.charts.TreeMap padding(Number[] padding) {
     ...
     * Setter for the chart paddings in pixels using a single value.
     */
    public com.anychart.charts.TreeMap padding(String[] padding) {
     ...
     */
    public com.anychart.charts.TreeMap right(Number right) {
     ...
     * Setter for element right bound setting.
     */
    public com.anychart.charts.TreeMap right(String right) {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public com.anychart.charts.TreeMap selectMarqueeFill(com.anychart.graphics.vector.Fill color) {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public com.anychart.charts.TreeMap selectMarqueeFill(com.anychart.graphics.vector.GradientKey color) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".selectMarqueeFill(%s);", (color != null) ? color.getJsBase() : null));
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public com.anychart.charts.TreeMap selectMarqueeFill(String[] color) {
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     ...
     */
    public com.anychart.charts.TreeMap selected(String settings) {
...
Ascending, Descending and No sorting is supported.
     */
    public com.anychart.charts.TreeMap sort(com.anychart.enums.Sort type) {
...
Ascending, Descending and No sorting is supported.
     */
    public com.anychart.charts.TreeMap sort(String type) {
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     ...
     */
    public com.anychart.charts.TreeMap stroke(String settings) {
     ...
     */
    public com.anychart.charts.TreeMap title(Boolean settings) {
     ...
     * Setter for the chart title.
     */
    public com.anychart.charts.TreeMap title(String settings) {
     ...
     */
    public com.anychart.charts.TreeMap tooltip(String settings) {
     ...
     * Setter for the chart tooltip.
     */
    public com.anychart.charts.TreeMap tooltip(Boolean settings) {
     ...
     */
    public com.anychart.charts.TreeMap top(Number top) {
     ...
     * Setter for element top bound settings.
     */
    public com.anychart.charts.TreeMap top(String top) {
     ...
     */
    public com.anychart.charts.TreeMap width(Number width) {
     ...
     * Setter for element width setting.
     */
    public com.anychart.charts.TreeMap width(String width) {
     ...
     */
    public com.anychart.charts.TreeMap zIndex(Number zIndex) {
     ...
     */
    public com.anychart.charts.TreeMap contextMenu(String settings) {
     ...
     * Setter for the context menu.
     */
    public com.anychart.charts.TreeMap contextMenu(Boolean settings) {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public com.anychart.charts.TreeMap parentBounds(com.anychart.math.Rect bounds) {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public com.anychart.charts.TreeMap parentBounds(String bounds) {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public com.anychart.charts.TreeMap parentBounds(Number bounds) {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public com.anychart.charts.TreeMap parentBounds(Number left, Number top, Number width, Number height) {
     ...
     * 
     */
    public com.anychart.charts.TreeMap fill(String value) {
