...
public class Pareto extends SeparateChart {
     ...
     */
    public com.anychart.charts.Pareto a11y(Boolean settings) {
     ...
     * Setter for the accessibility setting.
     */
    public com.anychart.charts.Pareto a11y(String settings) {
     ...
     */
    public com.anychart.charts.Pareto annotations(String[] annotationsList) {
...
Flag whether to automatically call chart.draw() on any changes or not.
     */
    public com.anychart.charts.Pareto autoRedraw(Boolean enabled) {
...
See illustration at {@link anychart.charts.Pareto#barsPadding}.
     */
    public com.anychart.charts.Pareto barGroupsPadding(Number padding) {
...
<img src='/si/8.4.0/anychart.charts.Pareto.barsPadding.png' width='396' height='294'/>
     */
    public com.anychart.charts.Pareto barsPadding(Number padding) {
...
The baseline is the line relative to which the series with the negative or positive value is drawn and painted over.
     */
    public com.anychart.charts.Pareto baseline(Number value) {
     ...
     */
    public com.anychart.charts.Pareto cancelMarquee() {
...
{docs:Quick_Start/Credits}Learn more about credits settings.{docs}
     */
    public com.anychart.charts.Pareto credits(String value) {
...
{docs:Quick_Start/Credits}Learn more about credits settings.{docs}
     */
    public com.anychart.charts.Pareto credits(Boolean value) {
     ...
     */
    public com.anychart.charts.Pareto crosshair(String settings) {
     ...
     * Setter for crosshair settings.
     */
    public com.anychart.charts.Pareto crosshair(Boolean settings) {
...
The data area is drawn along the data bounds.
     */
    public com.anychart.charts.Pareto dataArea(String settings) {
...
The data area is drawn along the data bounds.
     */
    public com.anychart.charts.Pareto dataArea(Boolean settings) {
     ...
     */
    public com.anychart.charts.Pareto defaultSeriesType(com.anychart.enums.CartesianSeriesType type) {
     ...
     * Setter for the series type.
     */
    public com.anychart.charts.Pareto defaultSeriesType(String type) {
     ...
     */
    public com.anychart.charts.Pareto exports(String settings) {
     ...
     */
    public com.anychart.charts.Pareto fullScreen(Boolean enabled) {
...
<b>Note:</b> Works only after {@link anychart.charts.Pareto#draw} is called.
     ...
     */
    public com.anychart.charts.Pareto hatchFillPalette(com.anychart.graphics.vector.hatchfill.HatchFillType[] settings) {
     ...
     * Setter for hatch fill palette settings.
     */
    public com.anychart.charts.Pareto hatchFillPalette(String settings) {
     ...
     * Setter for hatch fill palette settings.
     */
    public com.anychart.charts.Pareto hatchFillPalette(com.anychart.palettes.HatchFills settings) {
     ...
     */
    public com.anychart.charts.Pareto hovered(String settings) {
     ...
     * Setter for chart id.
     */
    public com.anychart.charts.Pareto id(String id) {
     ...
     */
    public com.anychart.charts.Pareto labels(String settings) {
     ...
     * Setter for series data labels.
     */
    public com.anychart.charts.Pareto labels(Boolean settings) {
     ...
     */
    public com.anychart.charts.Pareto lineMarker(String settings) {
     ...
     * Setter for the line marker settings.
     */
    public com.anychart.charts.Pareto lineMarker(Boolean settings) {
     ...
     */
    public com.anychart.charts.Pareto lineMarker(Number index, String settings) {
     ...
     * Setter for the line marker settings by index.
     */
    public com.anychart.charts.Pareto lineMarker(Number index, Boolean settings) {
     ...
     */
    public com.anychart.charts.Pareto markerPalette(com.anychart.palettes.Markers settings) {
     ...
     * Setter for chart markers palette settings.
     */
    public com.anychart.charts.Pareto markerPalette(String settings) {
     ...
     * Setter for chart markers palette settings.
     */
    public com.anychart.charts.Pareto markerPalette(com.anychart.enums.MarkerType settings) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".markerPalette(%s);", (settings != null) ? settings.getJsBase() : null));
     ...
     */
    public com.anychart.charts.Pareto maxBubbleSize(Number size) {
     ...
     * Setter for the maximum size for all bubbles on the charts.
     */
    public com.anychart.charts.Pareto maxBubbleSize(String size) {
     ...
     */
    public com.anychart.charts.Pareto maxLabels(String settings) {
     ...
     * Setter for maximum labels.
     */
    public com.anychart.charts.Pareto maxLabels(Boolean settings) {
     ...
     */
    public com.anychart.charts.Pareto maxPointWidth(Number width) {
     ...
     * Setter for the maximum point width.
     */
    public com.anychart.charts.Pareto maxPointWidth(String width) {
     ...
     */
    public com.anychart.charts.Pareto minBubbleSize(Number size) {
     ...
     * Setter for the minimum size for all bubbles on the charts.
     */
    public com.anychart.charts.Pareto minBubbleSize(String size) {
...
Setter for minimum labels.
     */
    public com.anychart.charts.Pareto minLabels(String settings) {
...
Setter for minimum labels.
     */
    public com.anychart.charts.Pareto minLabels(Boolean settings) {
     ...
     */
    public com.anychart.charts.Pareto minPointLength(Number length) {
     ...
     * Setter for the minimum point length.
     */
    public com.anychart.charts.Pareto minPointLength(String length) {
...
{docs:Working_with_Data/No_Data_Label} Learn more about "No data" feature {docs}
     */
    public com.anychart.charts.Pareto noData(String settings) {
     ...
     */
    public com.anychart.charts.Pareto normal(String settings) {
     ...
     */
    public com.anychart.charts.Pareto palette(com.anychart.palettes.RangeColors settings) {
     ...
     * Setter for the chart colors palette.
     */
    public com.anychart.charts.Pareto palette(com.anychart.palettes.DistinctColors settings) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".palette(%s);", (settings != null) ? settings.getJsBase() : null));
     ...
     * Setter for the chart colors palette.
     */
    public com.anychart.charts.Pareto palette(String settings) {
     ...
     */
    public com.anychart.charts.Pareto pointWidth(Number width) {
     ...
     * Setter for the point width settings.
     */
    public com.anychart.charts.Pareto pointWidth(String width) {
     ...
     */
    public com.anychart.charts.Pareto rangeMarker(String settings) {
     ...
     * Setter for the range marker.
     */
    public com.anychart.charts.Pareto rangeMarker(Boolean settings) {
     ...
     */
    public com.anychart.charts.Pareto rangeMarker(Number index, String settings) {
     ...
     * Setter for the range marker by index.
     */
    public com.anychart.charts.Pareto rangeMarker(Number index, Boolean settings) {
     ...
     */
    public com.anychart.charts.Pareto removeAllSeries() {
     ...
     */
    public com.anychart.charts.Pareto removeSeries(Number id) {
     ...
     * Removes one of series from chart by its id.
     */
    public com.anychart.charts.Pareto removeSeries(String id) {
     ...
     */
    public com.anychart.charts.Pareto removeSeriesAt(Number index) {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public com.anychart.charts.Pareto selectMarqueeFill(com.anychart.graphics.vector.Fill color) {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public com.anychart.charts.Pareto selectMarqueeFill(com.anychart.graphics.vector.GradientKey color) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".selectMarqueeFill(%s);", (color != null) ? color.getJsBase() : null));
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public com.anychart.charts.Pareto selectMarqueeFill(String[] color) {
     ...
     */
    public com.anychart.charts.Pareto selectMarqueeFill(String color, Number opacity) {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public com.anychart.charts.Pareto selectMarqueeFill(com.anychart.graphics.vector.GradientKey keys, Number angle, Boolean mode, Number opacity) {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public com.anychart.charts.Pareto selectMarqueeFill(com.anychart.graphics.vector.GradientKey keys, Number angle, com.anychart.graphics.vector.Rect mode, Number opacity) {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public com.anychart.charts.Pareto selectMarqueeFill(com.anychart.graphics.vector.GradientKey keys, Number angle, String mode, Number opacity) {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public com.anychart.charts.Pareto selectMarqueeFill(String[] keys, Number angle, Boolean mode, Number opacity) {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public com.anychart.charts.Pareto selectMarqueeFill(String[] keys, Number angle, com.anychart.graphics.vector.Rect mode, Number opacity) {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public com.anychart.charts.Pareto selectMarqueeFill(String[] keys, Number angle, String mode, Number opacity) {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public com.anychart.charts.Pareto selectMarqueeFill(com.anychart.graphics.vector.GradientKey keys, Number cx, Number cy, com.anychart.graphics.math.Rect mode, Number opacity, Number fx, Number fy) {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public com.anychart.charts.Pareto selectMarqueeFill(String[] keys, Number cx, Number cy, com.anychart.graphics.math.Rect mode, Number opacity, Number fx, Number fy) {
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public com.anychart.charts.Pareto selectMarqueeStroke(com.anychart.graphics.vector.Stroke color, Number thickness, String dashpattern, String lineJoin, String lineCap) {
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public com.anychart.charts.Pareto selectMarqueeStroke(com.anychart.graphics.vector.Stroke color, Number thickness, String dashpattern, String lineJoin, com.anychart.graphics.vector.StrokeLineCap lineCap) {
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public com.anychart.charts.Pareto selectMarqueeStroke(com.anychart.graphics.vector.Stroke color, Number thickness, String dashpattern, com.anychart.graphics.vector.StrokeLineJoin lineJoin, String lineCap) {
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public com.anychart.charts.Pareto selectMarqueeStroke(com.anychart.graphics.vector.Stroke color, Number thickness, String dashpattern, com.anychart.graphics.vector.StrokeLineJoin lineJoin, com.anychart.graphics.vector.StrokeLineCap lineCap) {
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public com.anychart.charts.Pareto selectMarqueeStroke(com.anychart.graphics.vector.ColoredFill color, Number thickness, String dashpattern, String lineJoin, String lineCap) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".selectMarqueeStroke(%s, %s, %s, %s, %s);", (color != null) ? color.getJsBase() : null, thickness, wrapQuotes(dashpattern), wrapQuotes(lineJoin), wrapQuotes(lineCap)));
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public com.anychart.charts.Pareto selectMarqueeStroke(com.anychart.graphics.vector.ColoredFill color, Number thickness, String dashpattern, String lineJoin, com.anychart.graphics.vector.StrokeLineCap lineCap) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".selectMarqueeStroke(%s, %s, %s, %s, %s);", (color != null) ? color.getJsBase() : null, thickness, wrapQuotes(dashpattern), wrapQuotes(lineJoin), (lineCap != null) ? lineCap.getJsBase() : null));
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public com.anychart.charts.Pareto selectMarqueeStroke(com.anychart.graphics.vector.ColoredFill color, Number thickness, String dashpattern, com.anychart.graphics.vector.StrokeLineJoin lineJoin, String lineCap) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".selectMarqueeStroke(%s, %s, %s, %s, %s);", (color != null) ? color.getJsBase() : null, thickness, wrapQuotes(dashpattern), (lineJoin != null) ? lineJoin.getJsBase() : null, wrapQuotes(lineCap)));
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public com.anychart.charts.Pareto selectMarqueeStroke(com.anychart.graphics.vector.ColoredFill color, Number thickness, String dashpattern, com.anychart.graphics.vector.StrokeLineJoin lineJoin, com.anychart.graphics.vector.StrokeLineCap lineCap) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".selectMarqueeStroke(%s, %s, %s, %s, %s);", (color != null) ? color.getJsBase() : null, thickness, wrapQuotes(dashpattern), (lineJoin != null) ? lineJoin.getJsBase() : null, (lineCap != null) ? lineCap.getJsBase() : null));
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public com.anychart.charts.Pareto selectMarqueeStroke(String color, Number thickness, String dashpattern, String lineJoin, String lineCap) {
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public com.anychart.charts.Pareto selectMarqueeStroke(String color, Number thickness, String dashpattern, String lineJoin, com.anychart.graphics.vector.StrokeLineCap lineCap) {
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public com.anychart.charts.Pareto selectMarqueeStroke(String color, Number thickness, String dashpattern, com.anychart.graphics.vector.StrokeLineJoin lineJoin, String lineCap) {
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public com.anychart.charts.Pareto selectMarqueeStroke(String color, Number thickness, String dashpattern, com.anychart.graphics.vector.StrokeLineJoin lineJoin, com.anychart.graphics.vector.StrokeLineCap lineCap) {
     ...
     */
    public com.anychart.charts.Pareto selected(String settings) {
...
<b>Note:</b> Works only after {@link anychart.core.Chart#draw} is called.
     */
    public com.anychart.charts.Pareto startSelectMarquee(Boolean repeat) {
     ...
     */
    public com.anychart.charts.Pareto textMarker(String settings) {
     ...
     * Setter for the text marker.
     */
    public com.anychart.charts.Pareto textMarker(Boolean settings) {
     ...
     */
    public com.anychart.charts.Pareto textMarker(Number index, String settings) {
     ...
     * Setter for the text marker by index.
     */
    public com.anychart.charts.Pareto textMarker(Number index, Boolean settings) {
     ...
     */
    public com.anychart.charts.Pareto xAxis(String settings) {
     ...
     * Setter for the chart X-axis.
     */
    public com.anychart.charts.Pareto xAxis(Boolean settings) {
     ...
     */
    public com.anychart.charts.Pareto xAxis(Number index, String settings) {
     ...
     * Setter for the chart X-axis by index.
     */
    public com.anychart.charts.Pareto xAxis(Number index, Boolean settings) {
     ...
     */
    public com.anychart.charts.Pareto xGrid(String settings) {
     ...
     * Setter for the chart grid by X-scale.
     */
    public com.anychart.charts.Pareto xGrid(Boolean settings) {
     ...
     */
    public com.anychart.charts.Pareto xGrid(Number index, String settings) {
     ...
     * Setter for chart grid by index.
     */
    public com.anychart.charts.Pareto xGrid(Number index, Boolean settings) {
     ...
     */
    public com.anychart.charts.Pareto xMinorGrid(String settings) {
     ...
     * Setter for the chart minor grid by X-scale.
     */
    public com.anychart.charts.Pareto xMinorGrid(Boolean settings) {
     ...
     */
    public com.anychart.charts.Pareto xMinorGrid(Number index, String settings) {
     ...
     * Setter for the chart minor grid by index.
     */
    public com.anychart.charts.Pareto xMinorGrid(Number index, Boolean settings) {
     ...
     */
    public com.anychart.charts.Pareto xScale(String settings) {
     ...
     * Setter for the chart X-scale.
     */
    public com.anychart.charts.Pareto xScale(com.anychart.enums.ScaleTypes settings) {
     ...
     * Setter for the chart X-scale.
     */
    public com.anychart.charts.Pareto xScale(com.anychart.scales.Base settings) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".xScale(%s);", (settings != null) ? settings.getJsBase() : null));
     ...
     */
    public com.anychart.charts.Pareto xScroller(String settings) {
     ...
     * Setter for the scroller.
     */
    public com.anychart.charts.Pareto xScroller(Boolean settings) {
     ...
     */
    public com.anychart.charts.Pareto xZoom(Number settings) {
     ...
     * Setter for the zoom settings.
     */
    public com.anychart.charts.Pareto xZoom(Boolean settings) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".xZoom(%s);", settings));
     ...
     * Setter for the zoom settings.
     */
    public com.anychart.charts.Pareto xZoom(String settings) {
     ...
     */
    public com.anychart.charts.Pareto yAxis(String settings) {
     ...
     * Setter for the chart Y-axis.
     */
    public com.anychart.charts.Pareto yAxis(Boolean settings) {
     ...
     */
    public com.anychart.charts.Pareto yAxis(Number index, String settings) {
     ...
     * Setter for the chart Y-axis by index.
     */
    public com.anychart.charts.Pareto yAxis(Number index, Boolean settings) {
     ...
     */
    public com.anychart.charts.Pareto yGrid(String settings) {
     ...
     * Setter for the chart grid by Y-scale.
     */
    public com.anychart.charts.Pareto yGrid(Boolean settings) {
     ...
     * Setter for chart grid by index.
     */
    public com.anychart.charts.Pareto yGrid(Number index, String settings) {
     ...
     * Setter for chart grid by index.
     */
    public com.anychart.charts.Pareto yGrid(Number index, Boolean settings) {
     ...
     */
    public com.anychart.charts.Pareto yMinorGrid(String settings) {
     ...
     * Setter for the chart minor grid by Y-scale.
     */
    public com.anychart.charts.Pareto yMinorGrid(Boolean settings) {
     ...
     * Setter for the chart minor grid by index.
     */
    public com.anychart.charts.Pareto yMinorGrid(Number index, String settings) {
     ...
     * Setter for the chart minor grid by index.
     */
    public com.anychart.charts.Pareto yMinorGrid(Number index, Boolean settings) {
     ...
     */
    public com.anychart.charts.Pareto yScale(String settings) {
     ...
     * Setter for the chart Y-scale.
     */
    public com.anychart.charts.Pareto yScale(com.anychart.enums.ScaleTypes settings) {
     ...
     * Setter for the chart Y-scale.
     */
    public com.anychart.charts.Pareto yScale(com.anychart.scales.Base settings) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".yScale(%s);", (settings != null) ? settings.getJsBase() : null));
     ...
     */
    public com.anychart.charts.Pareto animation(Boolean settings) {
     ...
     * Setter for animation settings by one value.
     */
    public com.anychart.charts.Pareto animation(String settings) {
     ...
     */
    public com.anychart.charts.Pareto animation(Boolean enabled, Number duration) {
     ...
     */
    public com.anychart.charts.Pareto background(String settings) {
     ...
     */
    public com.anychart.charts.Pareto bottom(Number bottom) {
     ...
     * Setter for element bottom bound settings.
     */
    public com.anychart.charts.Pareto bottom(String bottom) {
     ...
     */
    public com.anychart.charts.Pareto bounds(com.anychart.utils.RectObj bounds) {
     ...
     * Setter for bounds of the element using one parameter.
     */
    public com.anychart.charts.Pareto bounds(com.anychart.math.Rect bounds) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".bounds(%s);", (bounds != null) ? bounds.getJsBase() : null));
     ...
     * Setter for bounds of the element using one parameter.
     */
    public com.anychart.charts.Pareto bounds(com.anychart.core.utils.Bounds bounds) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".bounds(%s);", (bounds != null) ? bounds.getJsBase() : null));
     ...
     */
    public com.anychart.charts.Pareto bounds(Number x, Number y, Number width, Number height) {
     ...
     * Setter for element bounds settings.
     */
    public com.anychart.charts.Pareto bounds(Number x, Number y, Number width, String height) {
     ...
     * Setter for element bounds settings.
     */
    public com.anychart.charts.Pareto bounds(Number x, Number y, String width, Number height) {
     ...
     * Setter for element bounds settings.
     */
    public com.anychart.charts.Pareto bounds(Number x, Number y, String width, String height) {
     ...
     * Setter for element bounds settings.
     */
    public com.anychart.charts.Pareto bounds(Number x, String y, Number width, Number height) {
     ...
     * Setter for element bounds settings.
     */
    public com.anychart.charts.Pareto bounds(Number x, String y, Number width, String height) {
     ...
     * Setter for element bounds settings.
     */
    public com.anychart.charts.Pareto bounds(Number x, String y, String width, Number height) {
     ...
     * Setter for element bounds settings.
     */
    public com.anychart.charts.Pareto bounds(Number x, String y, String width, String height) {
     ...
     * Setter for element bounds settings.
     */
    public com.anychart.charts.Pareto bounds(String x, Number y, Number width, Number height) {
     ...
     * Setter for element bounds settings.
     */
    public com.anychart.charts.Pareto bounds(String x, Number y, Number width, String height) {
     ...
     * Setter for element bounds settings.
     */
    public com.anychart.charts.Pareto bounds(String x, Number y, String width, Number height) {
     ...
     * Setter for element bounds settings.
     */
    public com.anychart.charts.Pareto bounds(String x, Number y, String width, String height) {
     ...
     * Setter for element bounds settings.
     */
    public com.anychart.charts.Pareto bounds(String x, String y, Number width, Number height) {
     ...
     * Setter for element bounds settings.
     */
    public com.anychart.charts.Pareto bounds(String x, String y, Number width, String height) {
     ...
     * Setter for element bounds settings.
     */
    public com.anychart.charts.Pareto bounds(String x, String y, String width, Number height) {
     ...
     * Setter for element bounds settings.
     */
    public com.anychart.charts.Pareto bounds(String x, String y, String width, String height) {
     ...
     */
    public com.anychart.charts.Pareto container(com.anychart.graphics.vector.Layer element) {
     ...
     * Setter for the element's container.
     */
    public com.anychart.charts.Pareto container(com.anychart.graphics.vector.Stage element) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".container(%s);", (element != null) ? element.getJsBase() : null));
     ...
     * Setter for the element's container.
     */
    public com.anychart.charts.Pareto container(String element) {
     ...
     */
    public com.anychart.charts.Pareto contextMenu(String settings) {
     ...
     * Setter for the context menu.
     */
    public com.anychart.charts.Pareto contextMenu(Boolean settings) {
     ...
     */
    public com.anychart.charts.Pareto draw(Boolean async) {
     ...
     */
    public com.anychart.charts.Pareto enabled(Boolean enabled) {
...
<b>Note:</b> Works only after {@link anychart.core.Chart#draw} is called.
     ...
     */
    public com.anychart.charts.Pareto height(Number height) {
     ...
     * Setter for element height setting.
     */
    public com.anychart.charts.Pareto height(String height) {
     ...
     */
    public com.anychart.charts.Pareto interactivity(String settings) {
     ...
     * Setter for interactivity settings for the chart.
     */
    public com.anychart.charts.Pareto interactivity(com.anychart.enums.HoverMode settings) {
     ...
     */
    public com.anychart.charts.Pareto label(Boolean settings) {
     ...
     * Setter for the chart label.
     */
    public com.anychart.charts.Pareto label(String index, Boolean settings) {
     ...
     * Setter for the chart label.
     */
    public com.anychart.charts.Pareto label(String index, String settings) {
     ...
     * Setter for the chart label.
     */
    public com.anychart.charts.Pareto label(Number index, Boolean settings) {
     ...
     * Setter for the chart label.
     */
    public com.anychart.charts.Pareto label(Number index, String settings) {
     ...
     */
    public com.anychart.charts.Pareto left(Number left) {
     ...
     * Setter for element left bound settings.
     */
    public com.anychart.charts.Pareto left(String left) {
     ...
     */
    public com.anychart.charts.Pareto legend(String settings) {
     ...
     * Setter for chart legend settings.
     */
    public com.anychart.charts.Pareto legend(Boolean settings) {
...
<img src='/si/8.4.0/anychart.core.Chart.prototype.margin.png' width='352' height='351'/>
     ...
     */
    public com.anychart.charts.Pareto margin(Number[] margin) {
     ...
     * Setter for the chart margin in pixels using a single complex object.
     */
    public com.anychart.charts.Pareto margin(String[] margin) {
     ...
     */
    public com.anychart.charts.Pareto margin(String value1, String value2, String value3, String value4) {
     ...
     * Setter for the chart margin in pixels using several simple values.
     */
    public com.anychart.charts.Pareto margin(String value1, String value2, String value3, Number value4) {
     ...
     * Setter for the chart margin in pixels using several simple values.
     */
    public com.anychart.charts.Pareto margin(String value1, String value2, Number value3, String value4) {
     ...
     * Setter for the chart margin in pixels using several simple values.
     */
    public com.anychart.charts.Pareto margin(String value1, String value2, Number value3, Number value4) {
     ...
     * Setter for the chart margin in pixels using several simple values.
     */
    public com.anychart.charts.Pareto margin(String value1, Number value2, String value3, String value4) {
     ...
     * Setter for the chart margin in pixels using several simple values.
     */
    public com.anychart.charts.Pareto margin(String value1, Number value2, String value3, Number value4) {
     ...
     * Setter for the chart margin in pixels using several simple values.
     */
    public com.anychart.charts.Pareto margin(String value1, Number value2, Number value3, String value4) {
     ...
     * Setter for the chart margin in pixels using several simple values.
     */
    public com.anychart.charts.Pareto margin(String value1, Number value2, Number value3, Number value4) {
     ...
     * Setter for the chart margin in pixels using several simple values.
     */
    public com.anychart.charts.Pareto margin(Number value1, String value2, String value3, String value4) {
     ...
     * Setter for the chart margin in pixels using several simple values.
     */
    public com.anychart.charts.Pareto margin(Number value1, String value2, String value3, Number value4) {
     ...
     * Setter for the chart margin in pixels using several simple values.
     */
    public com.anychart.charts.Pareto margin(Number value1, String value2, Number value3, String value4) {
     ...
     * Setter for the chart margin in pixels using several simple values.
     */
    public com.anychart.charts.Pareto margin(Number value1, String value2, Number value3, Number value4) {
     ...
     * Setter for the chart margin in pixels using several simple values.
     */
    public com.anychart.charts.Pareto margin(Number value1, Number value2, String value3, String value4) {
     ...
     * Setter for the chart margin in pixels using several simple values.
     */
    public com.anychart.charts.Pareto margin(Number value1, Number value2, String value3, Number value4) {
     ...
     * Setter for the chart margin in pixels using several simple values.
     */
    public com.anychart.charts.Pareto margin(Number value1, Number value2, Number value3, String value4) {
     ...
     * Setter for the chart margin in pixels using several simple values.
     */
    public com.anychart.charts.Pareto margin(Number value1, Number value2, Number value3, Number value4) {
     ...
     */
    public com.anychart.charts.Pareto maxHeight(Number height) {
     ...
     * Setter for the maximum height.
     */
    public com.anychart.charts.Pareto maxHeight(String height) {
     ...
     */
    public com.anychart.charts.Pareto maxWidth(Number width) {
     ...
     * Setter for the maximum width.
     */
    public com.anychart.charts.Pareto maxWidth(String width) {
     ...
     */
    public com.anychart.charts.Pareto minHeight(Number height) {
     ...
     * Setter for the minimum height.
     */
    public com.anychart.charts.Pareto minHeight(String height) {
     ...
     */
    public com.anychart.charts.Pareto minWidth(Number width) {
     ...
     * Setter for the minimum width.
     */
    public com.anychart.charts.Pareto minWidth(String width) {
...
<img src='/si/8.4.0/anychart.core.Chart.prototype.padding.png' width='352' height='351'/>
     ...
     */
    public com.anychart.charts.Pareto padding(Number[] padding) {
     ...
     * Setter for the chart paddings in pixels using a single value.
     */
    public com.anychart.charts.Pareto padding(String[] padding) {
     ...
     */
    public com.anychart.charts.Pareto padding(String value1, String value2, String value3, String value4) {
     ...
     * Setter for the chart paddings in pixels using several numbers.
     */
    public com.anychart.charts.Pareto padding(String value1, String value2, String value3, Number value4) {
     ...
     * Setter for the chart paddings in pixels using several numbers.
     */
    public com.anychart.charts.Pareto padding(String value1, String value2, Number value3, String value4) {
     ...
     * Setter for the chart paddings in pixels using several numbers.
     */
    public com.anychart.charts.Pareto padding(String value1, String value2, Number value3, Number value4) {
     ...
     * Setter for the chart paddings in pixels using several numbers.
     */
    public com.anychart.charts.Pareto padding(String value1, Number value2, String value3, String value4) {
     ...
     * Setter for the chart paddings in pixels using several numbers.
     */
    public com.anychart.charts.Pareto padding(String value1, Number value2, String value3, Number value4) {
     ...
     * Setter for the chart paddings in pixels using several numbers.
     */
    public com.anychart.charts.Pareto padding(String value1, Number value2, Number value3, String value4) {
     ...
     * Setter for the chart paddings in pixels using several numbers.
     */
    public com.anychart.charts.Pareto padding(String value1, Number value2, Number value3, Number value4) {
     ...
     * Setter for the chart paddings in pixels using several numbers.
     */
    public com.anychart.charts.Pareto padding(Number value1, String value2, String value3, String value4) {
     ...
     * Setter for the chart paddings in pixels using several numbers.
     */
    public com.anychart.charts.Pareto padding(Number value1, String value2, String value3, Number value4) {
     ...
     * Setter for the chart paddings in pixels using several numbers.
     */
    public com.anychart.charts.Pareto padding(Number value1, String value2, Number value3, String value4) {
     ...
     * Setter for the chart paddings in pixels using several numbers.
     */
    public com.anychart.charts.Pareto padding(Number value1, String value2, Number value3, Number value4) {
     ...
     * Setter for the chart paddings in pixels using several numbers.
     */
    public com.anychart.charts.Pareto padding(Number value1, Number value2, String value3, String value4) {
     ...
     * Setter for the chart paddings in pixels using several numbers.
     */
    public com.anychart.charts.Pareto padding(Number value1, Number value2, String value3, Number value4) {
     ...
     * Setter for the chart paddings in pixels using several numbers.
     */
    public com.anychart.charts.Pareto padding(Number value1, Number value2, Number value3, String value4) {
     ...
     * Setter for the chart paddings in pixels using several numbers.
     */
    public com.anychart.charts.Pareto padding(Number value1, Number value2, Number value3, Number value4) {
     ...
     */
    public com.anychart.charts.Pareto right(Number right) {
     ...
     * Setter for element right bound setting.
     */
    public com.anychart.charts.Pareto right(String right) {
     ...
     */
    public com.anychart.charts.Pareto title(Boolean settings) {
     ...
     * Setter for the chart title.
     */
    public com.anychart.charts.Pareto title(String settings) {
     ...
     */
    public com.anychart.charts.Pareto tooltip(String settings) {
     ...
     * Setter for the chart tooltip.
     */
    public com.anychart.charts.Pareto tooltip(Boolean settings) {
     ...
     */
    public com.anychart.charts.Pareto top(Number top) {
     ...
     * Setter for element top bound settings.
     */
    public com.anychart.charts.Pareto top(String top) {
     ...
     */
    public com.anychart.charts.Pareto width(Number width) {
     ...
     * Setter for element width setting.
     */
    public com.anychart.charts.Pareto width(String width) {
     ...
     */
    public com.anychart.charts.Pareto zIndex(Number zIndex) {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public com.anychart.charts.Pareto parentBounds(com.anychart.math.Rect bounds) {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public com.anychart.charts.Pareto parentBounds(String bounds) {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public com.anychart.charts.Pareto parentBounds(Number bounds) {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public com.anychart.charts.Pareto parentBounds(Number left, Number top, Number width, Number height) {
