...
public class Bullet extends Chart {
    ...
    public Bullet(String jsChart) {
        jsBase = "bullet" + ++variableIndex;
     ...
     */
    public com.anychart.charts.Bullet a11y(Boolean settings) {
     ...
     * Setter for the accessibility setting.
     */
    public com.anychart.charts.Bullet a11y(String settings) {
     ...
     */
    public com.anychart.charts.Bullet animation(Boolean settings) {
     ...
     * Setter for animation settings by one value.
     */
    public com.anychart.charts.Bullet animation(String settings) {
     ...
     */
    public com.anychart.charts.Bullet animation(Boolean enabled, Number duration) {
...
Flag whether to automatically call chart.draw() on any changes or not.
     */
    public com.anychart.charts.Bullet autoRedraw(Boolean enabled) {
     ...
     */
    public com.anychart.charts.Bullet axis(String settings) {
     ...
     * Setter for the bullet chart axis settings.
     */
    public com.anychart.charts.Bullet axis(Boolean settings) {
     ...
     */
    public com.anychart.charts.Bullet background(String settings) {
     ...
     */
    public com.anychart.charts.Bullet bottom(Number bottom) {
     ...
     * Setter for element bottom bound settings.
     */
    public com.anychart.charts.Bullet bottom(String bottom) {
     ...
     */
    public com.anychart.charts.Bullet bounds(com.anychart.utils.RectObj bounds) {
     ...
     * Setter for bounds of the element using one parameter.
     */
    public com.anychart.charts.Bullet bounds(com.anychart.math.Rect bounds) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".bounds(%s);", (bounds != null) ? bounds.getJsBase() : null));
     ...
     * Setter for bounds of the element using one parameter.
     */
    public com.anychart.charts.Bullet bounds(com.anychart.core.utils.Bounds bounds) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".bounds(%s);", (bounds != null) ? bounds.getJsBase() : null));
     ...
     */
    public com.anychart.charts.Bullet bounds(Number x, Number y, Number width, Number height) {
     ...
     * Setter for element bounds settings.
     */
    public com.anychart.charts.Bullet bounds(Number x, Number y, Number width, String height) {
     ...
     * Setter for element bounds settings.
     */
    public com.anychart.charts.Bullet bounds(Number x, Number y, String width, Number height) {
     ...
     * Setter for element bounds settings.
     */
    public com.anychart.charts.Bullet bounds(Number x, Number y, String width, String height) {
     ...
     * Setter for element bounds settings.
     */
    public com.anychart.charts.Bullet bounds(Number x, String y, Number width, Number height) {
     ...
     * Setter for element bounds settings.
     */
    public com.anychart.charts.Bullet bounds(Number x, String y, Number width, String height) {
     ...
     * Setter for element bounds settings.
     */
    public com.anychart.charts.Bullet bounds(Number x, String y, String width, Number height) {
     ...
     * Setter for element bounds settings.
     */
    public com.anychart.charts.Bullet bounds(Number x, String y, String width, String height) {
     ...
     * Setter for element bounds settings.
     */
    public com.anychart.charts.Bullet bounds(String x, Number y, Number width, Number height) {
     ...
     * Setter for element bounds settings.
     */
    public com.anychart.charts.Bullet bounds(String x, Number y, Number width, String height) {
     ...
     * Setter for element bounds settings.
     */
    public com.anychart.charts.Bullet bounds(String x, Number y, String width, Number height) {
     ...
     * Setter for element bounds settings.
     */
    public com.anychart.charts.Bullet bounds(String x, Number y, String width, String height) {
     ...
     * Setter for element bounds settings.
     */
    public com.anychart.charts.Bullet bounds(String x, String y, Number width, Number height) {
     ...
     * Setter for element bounds settings.
     */
    public com.anychart.charts.Bullet bounds(String x, String y, Number width, String height) {
     ...
     * Setter for element bounds settings.
     */
    public com.anychart.charts.Bullet bounds(String x, String y, String width, Number height) {
     ...
     * Setter for element bounds settings.
     */
    public com.anychart.charts.Bullet bounds(String x, String y, String width, String height) {
     ...
     */
    public com.anychart.charts.Bullet cancelMarquee() {
     ...
     */
    public com.anychart.charts.Bullet container(com.anychart.graphics.vector.Layer element) {
     ...
     * Setter for the element's container.
     */
    public com.anychart.charts.Bullet container(com.anychart.graphics.vector.Stage element) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".container(%s);", (element != null) ? element.getJsBase() : null));
     ...
     * Setter for the element's container.
     */
    public com.anychart.charts.Bullet container(String element) {
     ...
     */
    public com.anychart.charts.Bullet contextMenu(String settings) {
     ...
     * Setter for the context menu.
     */
    public com.anychart.charts.Bullet contextMenu(Boolean settings) {
...
{docs:Quick_Start/Credits}Learn more about credits settings.{docs}
     */
    public com.anychart.charts.Bullet credits(String value) {
...
{docs:Quick_Start/Credits}Learn more about credits settings.{docs}
     */
    public com.anychart.charts.Bullet credits(Boolean value) {
     ...
     */
    public com.anychart.charts.Bullet draw(Boolean async) {
     ...
     */
    public com.anychart.charts.Bullet enabled(Boolean enabled) {
     ...
     */
    public com.anychart.charts.Bullet exports(String settings) {
     ...
     */
    public com.anychart.charts.Bullet fullScreen(Boolean enabled) {
...
<b>Note:</b> Works only after {@link anychart.core.Chart#draw} is called.
     ...
     */
    public com.anychart.charts.Bullet height(Number height) {
     ...
     * Setter for element height setting.
     */
    public com.anychart.charts.Bullet height(String height) {
     ...
     * Setter for chart id.
     */
    public com.anychart.charts.Bullet id(String id) {
...
Layout is defined by {@link anychart.charts.Bullet#layout} method.
     ...
     */
    public com.anychart.charts.Bullet label(Boolean settings) {
     ...
     * Setter for the chart label.
     */
    public com.anychart.charts.Bullet label(String index, Boolean settings) {
     ...
     * Setter for the chart label.
     */
    public com.anychart.charts.Bullet label(String index, String settings) {
     ...
     * Setter for the chart label.
     */
    public com.anychart.charts.Bullet label(Number index, Boolean settings) {
     ...
     * Setter for the chart label.
     */
    public com.anychart.charts.Bullet label(Number index, String settings) {
     ...
     */
    public com.anychart.charts.Bullet layout(com.anychart.enums.Layout layout) {
     ...
     * Setter for the chart layout.
     */
    public com.anychart.charts.Bullet layout(String layout) {
     ...
     */
    public com.anychart.charts.Bullet left(Number left) {
     ...
     * Setter for element left bound settings.
     */
    public com.anychart.charts.Bullet left(String left) {
...
<img src='/si/8.4.0/anychart.core.Chart.prototype.margin.png' width='352' height='351'/>
     ...
     */
    public com.anychart.charts.Bullet margin(Number[] margin) {
     ...
     * Setter for the chart margin in pixels using a single complex object.
     */
    public com.anychart.charts.Bullet margin(String[] margin) {
     ...
     */
    public com.anychart.charts.Bullet margin(String value1, String value2, String value3, String value4) {
     ...
     * Setter for the chart margin in pixels using several simple values.
     */
    public com.anychart.charts.Bullet margin(String value1, String value2, String value3, Number value4) {
     ...
     * Setter for the chart margin in pixels using several simple values.
     */
    public com.anychart.charts.Bullet margin(String value1, String value2, Number value3, String value4) {
     ...
     * Setter for the chart margin in pixels using several simple values.
     */
    public com.anychart.charts.Bullet margin(String value1, String value2, Number value3, Number value4) {
     ...
     * Setter for the chart margin in pixels using several simple values.
     */
    public com.anychart.charts.Bullet margin(String value1, Number value2, String value3, String value4) {
     ...
     * Setter for the chart margin in pixels using several simple values.
     */
    public com.anychart.charts.Bullet margin(String value1, Number value2, String value3, Number value4) {
     ...
     * Setter for the chart margin in pixels using several simple values.
     */
    public com.anychart.charts.Bullet margin(String value1, Number value2, Number value3, String value4) {
     ...
     * Setter for the chart margin in pixels using several simple values.
     */
    public com.anychart.charts.Bullet margin(String value1, Number value2, Number value3, Number value4) {
     ...
     * Setter for the chart margin in pixels using several simple values.
     */
    public com.anychart.charts.Bullet margin(Number value1, String value2, String value3, String value4) {
     ...
     * Setter for the chart margin in pixels using several simple values.
     */
    public com.anychart.charts.Bullet margin(Number value1, String value2, String value3, Number value4) {
     ...
     * Setter for the chart margin in pixels using several simple values.
     */
    public com.anychart.charts.Bullet margin(Number value1, String value2, Number value3, String value4) {
     ...
     * Setter for the chart margin in pixels using several simple values.
     */
    public com.anychart.charts.Bullet margin(Number value1, String value2, Number value3, Number value4) {
     ...
     * Setter for the chart margin in pixels using several simple values.
     */
    public com.anychart.charts.Bullet margin(Number value1, Number value2, String value3, String value4) {
     ...
     * Setter for the chart margin in pixels using several simple values.
     */
    public com.anychart.charts.Bullet margin(Number value1, Number value2, String value3, Number value4) {
     ...
     * Setter for the chart margin in pixels using several simple values.
     */
    public com.anychart.charts.Bullet margin(Number value1, Number value2, Number value3, String value4) {
     ...
     * Setter for the chart margin in pixels using several simple values.
     */
    public com.anychart.charts.Bullet margin(Number value1, Number value2, Number value3, Number value4) {
...
<b>Note:</b> Markers sets in {api:anychart.charts.Bullet#data}data(){api}.
     */
    public com.anychart.charts.Bullet markerPalette(com.anychart.enums.MarkerType settings) {
...
<b>Note:</b> Markers sets in {api:anychart.charts.Bullet#data}data(){api}.
     */
    public com.anychart.charts.Bullet markerPalette(String[] settings) {
...
<b>Note:</b> Markers sets in {api:anychart.charts.Bullet#data}data(){api}.
     */
    public com.anychart.charts.Bullet markerPalette(com.anychart.palettes.Markers settings) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".markerPalette(%s);", (settings != null) ? settings.getJsBase() : null));
     ...
     */
    public com.anychart.charts.Bullet maxHeight(Number height) {
     ...
     * Setter for the maximum height.
     */
    public com.anychart.charts.Bullet maxHeight(String height) {
     ...
     */
    public com.anychart.charts.Bullet maxWidth(Number width) {
     ...
     * Setter for the maximum width.
     */
    public com.anychart.charts.Bullet maxWidth(String width) {
     ...
     */
    public com.anychart.charts.Bullet minHeight(Number height) {
     ...
     * Setter for the minimum height.
     */
    public com.anychart.charts.Bullet minHeight(String height) {
     ...
     */
    public com.anychart.charts.Bullet minWidth(Number width) {
     ...
     * Setter for the minimum width.
     */
    public com.anychart.charts.Bullet minWidth(String width) {
...
{docs:Working_with_Data/No_Data_Label} Learn more about "No data" feature {docs}
     */
    public com.anychart.charts.Bullet noData(String settings) {
...
<img src='/si/8.4.0/anychart.core.Chart.prototype.padding.png' width='352' height='351'/>
     ...
     */
    public com.anychart.charts.Bullet padding(Number[] padding) {
     ...
     * Setter for the chart paddings in pixels using a single value.
     */
    public com.anychart.charts.Bullet padding(String[] padding) {
     ...
     */
    public com.anychart.charts.Bullet padding(String value1, String value2, String value3, String value4) {
     ...
     * Setter for the chart paddings in pixels using several numbers.
     */
    public com.anychart.charts.Bullet padding(String value1, String value2, String value3, Number value4) {
     ...
     * Setter for the chart paddings in pixels using several numbers.
     */
    public com.anychart.charts.Bullet padding(String value1, String value2, Number value3, String value4) {
     ...
     * Setter for the chart paddings in pixels using several numbers.
     */
    public com.anychart.charts.Bullet padding(String value1, String value2, Number value3, Number value4) {
     ...
     * Setter for the chart paddings in pixels using several numbers.
     */
    public com.anychart.charts.Bullet padding(String value1, Number value2, String value3, String value4) {
     ...
     * Setter for the chart paddings in pixels using several numbers.
     */
    public com.anychart.charts.Bullet padding(String value1, Number value2, String value3, Number value4) {
     ...
     * Setter for the chart paddings in pixels using several numbers.
     */
    public com.anychart.charts.Bullet padding(String value1, Number value2, Number value3, String value4) {
     ...
     * Setter for the chart paddings in pixels using several numbers.
     */
    public com.anychart.charts.Bullet padding(String value1, Number value2, Number value3, Number value4) {
     ...
     * Setter for the chart paddings in pixels using several numbers.
     */
    public com.anychart.charts.Bullet padding(Number value1, String value2, String value3, String value4) {
     ...
     * Setter for the chart paddings in pixels using several numbers.
     */
    public com.anychart.charts.Bullet padding(Number value1, String value2, String value3, Number value4) {
     ...
     * Setter for the chart paddings in pixels using several numbers.
     */
    public com.anychart.charts.Bullet padding(Number value1, String value2, Number value3, String value4) {
     ...
     * Setter for the chart paddings in pixels using several numbers.
     */
    public com.anychart.charts.Bullet padding(Number value1, String value2, Number value3, Number value4) {
     ...
     * Setter for the chart paddings in pixels using several numbers.
     */
    public com.anychart.charts.Bullet padding(Number value1, Number value2, String value3, String value4) {
     ...
     * Setter for the chart paddings in pixels using several numbers.
     */
    public com.anychart.charts.Bullet padding(Number value1, Number value2, String value3, Number value4) {
     ...
     * Setter for the chart paddings in pixels using several numbers.
     */
    public com.anychart.charts.Bullet padding(Number value1, Number value2, Number value3, String value4) {
     ...
     * Setter for the chart paddings in pixels using several numbers.
     */
    public com.anychart.charts.Bullet padding(Number value1, Number value2, Number value3, Number value4) {
     ...
     */
    public com.anychart.core.axismarkers.Range range(Number index) {
        return new com.anychart.core.axismarkers.Range(String.format(Locale.US, jsBase + ".range(%s)", index));
    }
    /**
     * Setter for chart first range settings.
     */
    public com.anychart.charts.Bullet range(String settings) {
     ...
     * Setter for chart first range settings.
     */
    public com.anychart.charts.Bullet range(Boolean settings) {
     ...
     */
    public com.anychart.charts.Bullet range(Number index, String settings) {
     ...
     * Setter for chart ranges settings by index.
     */
    public com.anychart.charts.Bullet range(Number index, Boolean settings) {
     ...
     */
    public com.anychart.palettes.DistinctColors rangePalette() {
        return new com.anychart.palettes.DistinctColors(jsBase + ".rangePalette()");
    }
    /**
     * Setter for the range palette settings.
     */
    public com.anychart.charts.Bullet rangePalette(com.anychart.palettes.DistinctColors settings) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".rangePalette(%s);", (settings != null) ? settings.getJsBase() : null));
     ...
     * Setter for the range palette settings.
     */
    public com.anychart.charts.Bullet rangePalette(String settings) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".rangePalette(%s);", wrapQuotes(settings)));
     ...
     */
    public com.anychart.charts.Bullet rangePalette(String[] settings) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".rangePalette(%s);", arrayToStringWrapQuotes(settings)));
     ...
     */
    public com.anychart.charts.Bullet right(Number right) {
     ...
     * Setter for element right bound setting.
     */
    public com.anychart.charts.Bullet right(String right) {
     ...
     */
    public com.anychart.charts.Bullet scale(com.anychart.scales.Base settings) {
     ...
     * Setter for the bullet chart scale settings.
     */
    public com.anychart.charts.Bullet scale(String settings) {
     ...
     * Setter for the bullet chart scale settings.
     */
    public com.anychart.charts.Bullet scale(com.anychart.enums.ScaleTypes settings) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".scale(%s);", (settings != null) ? settings.getJsBase() : null));
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public com.anychart.charts.Bullet selectMarqueeFill(com.anychart.graphics.vector.Fill color) {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public com.anychart.charts.Bullet selectMarqueeFill(com.anychart.graphics.vector.GradientKey color) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".selectMarqueeFill(%s);", (color != null) ? color.getJsBase() : null));
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public com.anychart.charts.Bullet selectMarqueeFill(String[] color) {
     ...
     */
    public com.anychart.charts.Bullet selectMarqueeFill(String color, Number opacity) {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public com.anychart.charts.Bullet selectMarqueeFill(com.anychart.graphics.vector.GradientKey keys, Number angle, Boolean mode, Number opacity) {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public com.anychart.charts.Bullet selectMarqueeFill(com.anychart.graphics.vector.GradientKey keys, Number angle, com.anychart.graphics.vector.Rect mode, Number opacity) {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public com.anychart.charts.Bullet selectMarqueeFill(com.anychart.graphics.vector.GradientKey keys, Number angle, String mode, Number opacity) {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public com.anychart.charts.Bullet selectMarqueeFill(String[] keys, Number angle, Boolean mode, Number opacity) {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public com.anychart.charts.Bullet selectMarqueeFill(String[] keys, Number angle, com.anychart.graphics.vector.Rect mode, Number opacity) {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public com.anychart.charts.Bullet selectMarqueeFill(String[] keys, Number angle, String mode, Number opacity) {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public com.anychart.charts.Bullet selectMarqueeFill(com.anychart.graphics.vector.GradientKey keys, Number cx, Number cy, com.anychart.graphics.math.Rect mode, Number opacity, Number fx, Number fy) {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public com.anychart.charts.Bullet selectMarqueeFill(String[] keys, Number cx, Number cy, com.anychart.graphics.math.Rect mode, Number opacity, Number fx, Number fy) {
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public com.anychart.charts.Bullet selectMarqueeStroke(com.anychart.graphics.vector.Stroke color, Number thickness, String dashpattern, String lineJoin, String lineCap) {
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public com.anychart.charts.Bullet selectMarqueeStroke(com.anychart.graphics.vector.Stroke color, Number thickness, String dashpattern, String lineJoin, com.anychart.graphics.vector.StrokeLineCap lineCap) {
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public com.anychart.charts.Bullet selectMarqueeStroke(com.anychart.graphics.vector.Stroke color, Number thickness, String dashpattern, com.anychart.graphics.vector.StrokeLineJoin lineJoin, String lineCap) {
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public com.anychart.charts.Bullet selectMarqueeStroke(com.anychart.graphics.vector.Stroke color, Number thickness, String dashpattern, com.anychart.graphics.vector.StrokeLineJoin lineJoin, com.anychart.graphics.vector.StrokeLineCap lineCap) {
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public com.anychart.charts.Bullet selectMarqueeStroke(com.anychart.graphics.vector.ColoredFill color, Number thickness, String dashpattern, String lineJoin, String lineCap) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".selectMarqueeStroke(%s, %s, %s, %s, %s);", (color != null) ? color.getJsBase() : null, thickness, wrapQuotes(dashpattern), wrapQuotes(lineJoin), wrapQuotes(lineCap)));
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public com.anychart.charts.Bullet selectMarqueeStroke(com.anychart.graphics.vector.ColoredFill color, Number thickness, String dashpattern, String lineJoin, com.anychart.graphics.vector.StrokeLineCap lineCap) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".selectMarqueeStroke(%s, %s, %s, %s, %s);", (color != null) ? color.getJsBase() : null, thickness, wrapQuotes(dashpattern), wrapQuotes(lineJoin), (lineCap != null) ? lineCap.getJsBase() : null));
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public com.anychart.charts.Bullet selectMarqueeStroke(com.anychart.graphics.vector.ColoredFill color, Number thickness, String dashpattern, com.anychart.graphics.vector.StrokeLineJoin lineJoin, String lineCap) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".selectMarqueeStroke(%s, %s, %s, %s, %s);", (color != null) ? color.getJsBase() : null, thickness, wrapQuotes(dashpattern), (lineJoin != null) ? lineJoin.getJsBase() : null, wrapQuotes(lineCap)));
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public com.anychart.charts.Bullet selectMarqueeStroke(com.anychart.graphics.vector.ColoredFill color, Number thickness, String dashpattern, com.anychart.graphics.vector.StrokeLineJoin lineJoin, com.anychart.graphics.vector.StrokeLineCap lineCap) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".selectMarqueeStroke(%s, %s, %s, %s, %s);", (color != null) ? color.getJsBase() : null, thickness, wrapQuotes(dashpattern), (lineJoin != null) ? lineJoin.getJsBase() : null, (lineCap != null) ? lineCap.getJsBase() : null));
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public com.anychart.charts.Bullet selectMarqueeStroke(String color, Number thickness, String dashpattern, String lineJoin, String lineCap) {
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public com.anychart.charts.Bullet selectMarqueeStroke(String color, Number thickness, String dashpattern, String lineJoin, com.anychart.graphics.vector.StrokeLineCap lineCap) {
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public com.anychart.charts.Bullet selectMarqueeStroke(String color, Number thickness, String dashpattern, com.anychart.graphics.vector.StrokeLineJoin lineJoin, String lineCap) {
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public com.anychart.charts.Bullet selectMarqueeStroke(String color, Number thickness, String dashpattern, com.anychart.graphics.vector.StrokeLineJoin lineJoin, com.anychart.graphics.vector.StrokeLineCap lineCap) {
...
<b>Note:</b> Works only after {@link anychart.core.Chart#draw} is called.
     */
    public com.anychart.charts.Bullet startSelectMarquee(Boolean repeat) {
     ...
     */
    public com.anychart.charts.Bullet title(Boolean settings) {
     ...
     * Setter for the chart title.
     */
    public com.anychart.charts.Bullet title(String settings) {
     ...
     */
    public com.anychart.charts.Bullet tooltip(String settings) {
     ...
     * Setter for the chart tooltip.
     */
    public com.anychart.charts.Bullet tooltip(Boolean settings) {
     ...
     */
    public com.anychart.charts.Bullet top(Number top) {
     ...
     * Setter for element top bound settings.
     */
    public com.anychart.charts.Bullet top(String top) {
     ...
     */
    public com.anychart.charts.Bullet width(Number width) {
     ...
     * Setter for element width setting.
     */
    public com.anychart.charts.Bullet width(String width) {
     ...
     */
    public com.anychart.charts.Bullet zIndex(Number zIndex) {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public com.anychart.charts.Bullet parentBounds(com.anychart.math.Rect bounds) {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public com.anychart.charts.Bullet parentBounds(String bounds) {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public com.anychart.charts.Bullet parentBounds(Number bounds) {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public com.anychart.charts.Bullet parentBounds(Number left, Number top, Number width, Number height) {
